[![Build Status](http://jenkins.jibo.com/buildStatus/icon?job=jibo-state-machine)](http://jenkins.jibo.com/job/jibo-state-machine/)
...
![A graphical rendering of the example state machine](res/example.png)
