...
<?js } else { ?>
<?js if (!doc.longname || doc.kind !== 'module' && doc.kind !== 'class') { ?> 
...
<?js if (doc.augments && doc.augments.length) { ?>
  <div class="extends">This class extends <?js= self.partial('augments.tmpl', doc) ?></div>
...
<?js if (c.summary) { ?><?js= c.summary ?><?js } ?><br>
<?js }); ?>
