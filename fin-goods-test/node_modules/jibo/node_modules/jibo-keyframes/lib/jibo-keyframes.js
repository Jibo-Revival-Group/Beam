...
var GlowLayer_1 = require('./layers/GlowLayer');
var LightingLayer_1 = require('./layers/LightingLayer');
...
JiboKeyframeInfo.layerTypes = {
    ...
    Glow: GlowLayer_1.default,
    Lighting: LightingLayer_1.default
};
...
},{"./layers/AudioLayer":6,"./layers/BackgroundTextureLayer":7,"./layers/BodyLayer":8,"./layers/EventLayer":9,"./layers/EyeLayer":11,"./layers/EyeTextureLayer":12,"./layers/GlowLayer":13,"./layers/LEDLayer":14,"./layers/LightingLayer":15,"./layers/OverlayLayer":16,"./layers/OverlayTextureLayer":17,"./layers/PixiLayer":18,"./layers/ReferenceLayer":19,"./utils/Colors":22,"./utils/Conversion":23,"./utils/IDUtils":24,"semver":undefined}],2:[function(require,module,exports){
"use strict";
/**
...
var Runtime = (function () {
    ...
    /**
     * Detect whether there were any Eye layers in the referenced layers.
     * @param {Keyframes} keyframes
     * @returns {boolean}
     */
    Runtime.hasReferencedEyeLayers = function (keyframes) {
        for (var i = 0; i < keyframes.layers.length; i++) {
            var layer = keyframes.layers[i];
            if (this.isReferencedLayer(layer) && layer.type === 'Eye') {
                return true;
            }
        }
        return false;
     ...
     * The overlay layers at top level are ignored.
    ...
    Runtime.evaluateAllLayersFiltered = function (keyframes, keyframeInfo, timeInSeconds, includeFilter, provideDefaults, overrides) {
        ...
        if (!this.hasReferencedEyeLayers(keyframes)) {
        ...
        var otherFilter = function (layer) {
            return includeFilter(layer) && layer.type !== 'Eye' && layer.type !== 'Overlay';
        };
        ...
        // Do the standard evaluation of all the non-Eye/Overlay layers.
    ...
    * */
    ...
    Runtime.evaluateLayer = function (layer, keyframes, keyframeInfo, timeInSeconds, override) {
        ...
        for (var propName in layerTypeInfo.properties) {
            defaults[propName] = _.cloneDeep(layerTypeInfo.properties[propName].defaultValue);
        }
...
},{"./utils/BlendOperations":20,"./utils/IDUtils":24,"./utils/Search":26,"./utils/Tweening":27,"fs":undefined,"lodash":undefined}],3:[function(require,module,exports){
"use strict";
...
},{"../bases/DOFBaseLayer":4,"../utils/Conversion":23,"lodash":undefined}],11:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../utils/Conversion":23,"./EyeAndOverlayLayer":10}],12:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
var GlowLayer = (function (_super) {
    ...
    GlowLayer.generateDofs = function (props) {
        return {
            glow_amount: !props.Enabled ? 0 : props.Amount,
            glow_blur: props.Blur,
            glow_halo: props.Halo,
            glow_haloMaxDistance: props.HaloMaxDistance,
            glow_redChannel: props.Color.r,
            glow_greenChannel: props.Color.g,
            glow_blueChannel: props.Color.b
        };
    };
    GlowLayer.getInfo = function () {
        return GlowInfo;
    };
    return GlowLayer;
}(DOFBaseLayer_1.default));
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = GlowLayer;
...
},{"../bases/DOFBaseLayer":4}],15:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
var LightingLayer = (function (_super) {
    __extends(LightingLayer, _super);
    function LightingLayer() {
        _super.apply(this, arguments);
    }
    LightingLayer.generateDofs = function (props) {
        return {
            lighting_amount: !props.Enabled ? 0 : props.Amount,
            lighting_brightness: props.Brightness,
            lighting_gradient: props.Gradient,
            lighting_radius: props.Radius,
            lighting_light_redChannel: props.Light.r,
            lighting_light_greenChannel: props.Light.g,
            lighting_light_blueChannel: props.Light.b,
            lighting_mid_redChannel: props.Mid.r,
            lighting_mid_greenChannel: props.Mid.g,
            lighting_mid_blueChannel: props.Mid.b,
            lighting_dark_redChannel: props.Dark.r,
            lighting_dark_greenChannel: props.Dark.g,
            lighting_dark_blueChannel: props.Dark.b
        };
    };
    LightingLayer.getInfo = function () {
        return LightingInfo;
    };
...
},{"../utils/Conversion":23,"./EyeAndOverlayLayer":10}],17:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../bases/EventBaseLayer":5}],19:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../bases/DOFBaseLayer":4}],20:[function(require,module,exports){
/**
...
var operations = {
    ...
    add: {
        ...
        rgb: function (accumulated, newValue, defaultValue) {
            return {
                r: accumulated.r + (newValue.r - defaultValue.r),
                g: accumulated.g + (newValue.g - defaultValue.g),
                b: accumulated.b + (newValue.b - defaultValue.b)
            };
        }
    },
    multiply: {
    ...
    inverse: {
        ...
        multiply: {
            ...
            rgb: function (accumulated, newValue) {
                return {
                    r: newValue.r / accumulated.r,
                    g: newValue.g / accumulated.g,
                    b: newValue.b / accumulated.b
                };
            }
        }
    }
...
},{"color-space/hsv":undefined}],23:[function(require,module,exports){
"use strict";
var 
...
},{"uuid":undefined}],25:[function(require,module,exports){
...
var KeysUtils = (function () {
    ...
    KeysUtils.keysObjToAnimObject = function (keysData, name) {
        /*
...
},{"../JiboKeyframeInfo":1,"../Runtime":2,"./Channels":21,"fs":undefined,"path":undefined}],26:[function(require,module,exports){
/**
 ...
 */
var easing = _.clone(easesFunctions);
/**
...
},{"eases":undefined,"lodash":undefined}],28:[function(require,module,exports){
"use strict";
/**
 * keyframes entry point.
 */
...
},{"./JiboKeyframeInfo":1,"./Runtime":2,"./utils/Channels":21,"./utils/Conversion":23,"./utils/IDUtils":24,"./utils/KeysUtils":25,"./utils/Search":26,"./utils/Tweening":27}]},{},[28])(28)
});
