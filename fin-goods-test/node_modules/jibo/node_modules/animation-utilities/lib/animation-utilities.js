...
},{"../ifr-motion/base/AccelPlanner":64,"../ifr-motion/base/Motion":71,"../ifr-motion/base/MotionTrack":74,"../ifr-motion/base/MotionValidator":75,"../ifr-motion/base/TimestampedBuffer":79,"./TransitionBuilder":5}],2:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
...
AnimationUtilities.prototype.createLookatBuilder = function () {
    return new SingleLookatBuilder(this.timeline, this.robotInfo, (this.defaultTransition === null) ? null : this.defaultTransition.clone(), this.globalLookatDelegate, new BlinkDelegate(this));
};
/**
...
AnimationBuilder.prototype.play = function () {
    ...
    if (this.transition) {
        var currentPose = this.timeline.getCurrentState([this.layer]).getPose();
        var targetMotion = this.motion.getMotion();
        var baseDOF = this.robotInfo.getDOFSet("BASE").getDOFs()[0];
        if (this.layer === "default" && this.stopOrient && this.dofNames.indexOf(baseDOF) !== -1) {
        ...
        var transitionMotion = this.transition.generateTransition(currentPose, targetMotion, this.clip.getInPoint(), this.dofNames);
    ...
    if (this.numLoops === 1) {
        animationClip = new SimpleMotionGenerator(this.motion.getMotion(), startTime.add(transitionDelay), this.robotInfo, this.dofNames, clipData);
        ...
        animationClip = new LoopedMotionGenerator(motionList, clipList, this.numLoops, startTime.add(transitionDelay), this.robotInfo, this.dofNames);
    ...
    animationClip = new VariableSpeedMotionGenerator(animationClip, this.clip.getSpeed());
...
},{"../animation-visualize/RendererOutput":40,"../geometry-info/DOFSet":42,"../ifr-core/SLog":54,"../ifr-motion/base/AnnotatedMotion":65,"../ifr-motion/base/Motion":71,"../ifr-motion/base/MotionEventIterator":73,"../ifr-motion/base/Pose":76,"../ifr-motion/base/RelativeTimeClip":77,"../ifr-motion/loaders/AnimationLoader":94,"../ifr-motion/lookat/KinematicFeaturesReporter":98,"../ifr-motion/lookat/PlaneDisplacementLookatDOF":108,"./AccelerationTransitionBuilder":1,"./LinearTransitionBuilderImpl":3,"./SingleLookatBuilder":4,"./timeline/LoopedMotionGenerator":13,"./timeline/SimpleMotionGenerator":20,"./timeline/TimelineEventDispatcher":21,"./timeline/VariableSpeedMotionGenerator":22,"three":undefined}],3:[function(require,module,exports){
/**
 * @author jg
 */
"use strict";
...
},{"../ifr-motion/base/Motion":71,"../ifr-motion/base/MotionTrack":74,"../ifr-motion/base/MotionValidator":75,"../ifr-motion/base/TimestampedBuffer":79,"./TransitionBuilder":5}],4:[function(require,module,exports){
/**
 * @author jg
 */
"use strict";
 ...
 * @private
 */
var SingleLookatBuilder = function (timeline, robotInfo, transition, globalDelegate, blinkDelegate) {
    var self = this;
    ...
    var lookatNodeRuntimeConfigs = {
        ...
        BaseLookatNode: new LookatNodeRuntimeConfig(null, 3, null, null, null, null, true, false, 0.03, 0.05, 0.018, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null),
        TorsoLookatNode: new LookatNodeRuntimeConfig(null, 2.5, null, null, null, null, true, false, 0.03, 0.05, 0.018, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null),
        TopLookatNode: new LookatNodeRuntimeConfig(null, 3, null, null, null, null, true, false, 0.03, 0.05, 0.018, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null),
        Eye: new LookatNodeRuntimeConfig(null, 1, null, null, null, null, true, false, 0.001, 0.05, 0.001, null, 2, 1, 0.001, null, null, null, null, null, null, null, null, null, null, null, null)
    };
    ...
    var getTrackPolicy = function (config, parentTrackPolicies) {
        ...
        var triggers = [];
        if (config.TPTPMoveIfParentMoves && parentTrackPolicies != null) {
    ...
    var initLookat = function () {
        ...
        var baseLookatNode = new LookatNode("BaseLookatNode", [
        ...
        var torsoLookatNode = new LookatNode("TorsoLookatNode", [
    ...
    var eventHandlers = {};
    /** @type {MotionLookat} */
    var lookat = initLookat(); //TODO: don't need this one initted, except for a few info accesses to work around
    /** @type {Pose} */
    var lookPose = new Pose("LookPose", lookat.getDOFs());
    this.motionLookat = lookat;
    /**
    ...
    this.startLookat = function (targetArg) {
        ...
        if (preRender) {
            ...
            for (i = 0; i < lookatLayerDOFs.length; i++) {
                ...
                lookat.generatePoseIncremental(initPose, lookPose, target, currentPoseTime, dofName);
...
},{"../geometry-info/DOFSet":42,"../ifr-core/SLog":54,"../ifr-motion/base/Motion":71,"../ifr-motion/base/Pose":76,"../ifr-motion/lookat/DiskStabilizationTracker":97,"../ifr-motion/lookat/LookatBlinkManager":99,"../ifr-motion/lookat/LookatMotionNode":101,"../ifr-motion/lookat/LookatNode":102,"../ifr-motion/lookat/LookatNodeTargetAdjuster":104,"../ifr-motion/lookat/LookatWindupPolicy":105,"../ifr-motion/lookat/MotionLookat":106,"../ifr-motion/lookat/OcularStabilizationTracker":107,"../ifr-motion/lookat/PlaneDisplacementLookatDOF":108,"../ifr-motion/lookat/RotationalLookatDOF":112,"../ifr-motion/lookat/RotationalPlaneAlignmentLookatDOF":113,"../ifr-motion/lookat/trackpolicy/LookatNodeTrackPolicy":114,"../ifr-motion/lookat/trackpolicy/TrackPolicyTriggerAlways":116,"../ifr-motion/lookat/trackpolicy/TrackPolicyTriggerDiscomfort":117,"../ifr-motion/lookat/trackpolicy/TrackPolicyTriggerMovementTerminated":118,"../ifr-motion/lookat/trackpolicy/TrackPolicyTriggerOnOtherNode":119,"./timeline/LookatMultiLayerStatusManager":12,"./timeline/SimpleMotionGenerator":20,"three":undefined}],5:[function(require,module,exports){
/**
 * @author jg
 */
"use strict";
 ...
 * @override
 */
AddSampleCombiner.prototype.combineSamples = function (dofName, samplePrev, sampleNew, properties) {
    var r = [];
...
},{"./SampleCombiner":17}],7:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
...
},{"./MotionGenerator":15,"./TimelineEventDispatcher":21}],9:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
 ...
 * @abstract
 */
LayerCombiner.prototype.combineLayers = function (layerNames, layerStates) {
};
/**
 ...
 * @abstract
 */
LayerCombiner.prototype.incrementState = function (combinedState, layerName, layerState, dofName) {
};
 ...
 * @override
 */
LookatMotionGenerator.prototype.getDOFState = function (dofName, partialRender, blackboard) {
    /** @type {number} */
...
},{"../../ifr-core/SLog":54,"../../ifr-motion/base/Pose":76,"./BaseMotionGenerator":8}],12:[function(require,module,exports){
/**
 * @author jg
 */
"use strict";
...
},{"../../ifr-core/SLog":54,"./LookatMotionGenerator":11,"./TimelineEventDispatcher":21}],13:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
 ...
 * @extends BaseMotionGenerator
 */
var LoopedMotionGenerator = function (motionList, clipList, numLoops, startTime, robotInfo, dofNames) {
    if (!motionList) {
    ...
    for (m = 0; m < motionList.length; m++) {
        if (this._durationList[m] === Number.MAX_VALUE) {
            this._loopDuration = Number.MAX_VALUE;
            break;
        }
        else {
    ...
    var duration = 0;
    if (numLoops === 0 || this._loopDuration === Number.MAX_VALUE) {
        // loop forever
...
LoopedMotionGenerator.prototype.setSourceTimeReportingEnabled = function (enabledFlags) {
    if (enabledFlags.length !== this._motionList.length) {
        throw new Error("enabledFlags length " + enabledFlags.length + " doesn't match motionList length " + this._motionList.length);
    }
 ...
 * @override
 */
LoopedMotionGenerator.prototype.getDOFState = function (dofName, partialRender, blackboard) {
    var relativeCurrentTime = this._currentTime.subtract(this.getStartTime());
    var relativeEndTime = this.getDurationForDOF(dofName);
    if (relativeEndTime !== null) {
        ...
        var sample = this._motionList[motionIndex].getDOFDataAtTime(dofName, sourceMotionTime, this._interpolatorSet.getInterpolator(dofName));
        if (this._sourceTimeReportingFlags && this._sourceTimeReportingFlags[motionIndex]) {
            ...
            blackboard.sourceTimes[this._motionList[motionIndex].getName()] = sourceMotionTime;
        }
        return sample;
    }
    else {
...
LoopedMotionGenerator.prototype.queueCustomEvents = function () {
    if (this.hasEntered() && !this.hasExited() && this._clipEventHandler && this._customEvents) {
        var relativeCurrentTime = this._currentTime.subtract(this.getStartTime());
        ...
        while (this._eventLoopIndex < loopIndex) {
            var m;
            for (m = 0; m < this._motionList.length; m++) {
        ...
        var motionIndex = 0;
        var motionTime = loopTime;
        while (motionIndex < this._motionList.length && motionTime >= 0) {
...
},{"../../ifr-motion/base/MotionValidator":75,"./BaseMotionGenerator":8,"./TimelineEventDispatcher":21}],14:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
...
},{"./SampleCombiner":17}],15:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
 ...
 * @virtual
 */
MotionGenerator.prototype.getDOFState = function (dofName, partialRender, blackboard) {
};
    ...
    for (dofIndex = 0; dofIndex < this._sortedDOFNames.length; dofIndex++) {
        ...
        for (layerIndex = 0; layerIndex < this._layerNames.length; layerIndex++) {
            ...
            if (this._dofMapByLayer[layerName].hasOwnProperty(dofName)) {
                ...
                newDOFState = null;
                if (generatorForDOF) {
                    newDOFState = generatorForDOF.getDOFState(dofName, this._systemState, this._blackboard);
                }
                else {
...
},{"../../ifr-core/SLog":54,"../../ifr-motion/base/CyclicMath":67,"../../ifr-motion/base/DOFGlobalAlignment":68,"../../ifr-motion/base/Pose":76,"./LayerState":10,"./TimelineEventDispatcher":21}],17:[function(require,module,exports){
/**
 * @author jg
 */
"use strict";
 ...
 * @abstract
 */
SampleCombiner.prototype.combineSamples = function (dofName, samplePrev, sampleNew, properties) {
};
...
},{"./SampleCombiner":17}],19:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
...
},{"./LayerCombiner":9}],20:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
 ...
 * @extends BaseMotionGenerator
 */
var SimpleMotionGenerator = function (motion, startTime, robotInfo, dofNames, clip) {
    if (dofNames === null || dofNames === undefined) {
    ...
    BaseMotionGenerator.call(this, motion.getName(), startTime, dofNames, clip.getDuration());
 ...
 * @override
 */
SimpleMotionGenerator.prototype.getDOFState = function (dofName, partialRender, blackboard) {
    var relativeCurrentTime = this._currentTime.subtract(this.getStartTime());
    var relativeEndTime = this.getDurationForDOF(dofName);
    if (relativeEndTime !== null) {
        var sampleTime = Math.min(relativeCurrentTime, relativeEndTime);
        var motionTime = this._clip.getSourceTime(sampleTime);
        var sample = this._motion.getDOFDataAtTime(dofName, motionTime, this._interpolatorSet.getInterpolator(dofName));
...
SimpleMotionGenerator.prototype.queueCustomEvents = function () {
    if (this.hasEntered() && !this.hasExited() && this._clipEventHandler && this._customEvents) {
        ...
        var relativeEndTime = this.getDuration();
        var sampleTime = Math.min(relativeCurrentTime, relativeEndTime);
        while (this._customEvents.hasNext(sampleTime)) {
            TimelineEventDispatcher.queueEvent(this._clipEventHandler, [this._customEvents.next(sampleTime)]);
        }
    }
};
module.exports = SimpleMotionGenerator;

},{"../../ifr-motion/base/MotionValidator":75,"../../ifr-motion/base/RelativeTimeClip":77,"./BaseMotionGenerator":8,"./TimelineEventDispatcher":21}],21:[function(require,module,exports){
/**
...
},{"../../ifr-core/SLog":54}],22:[function(require,module,exports){
/**
 * @author mattb
 ...
 * @extends MotionGenerator
 */
var VariableSpeedMotionGenerator = function (generator, initialSpeed) {
    MotionGenerator.call(this);
    /** @type {MotionGenerator} */
    this._generator = generator;
    /** @type {RelativeTimeClip} */
    this._clip = new RelativeTimeClip(0, generator.getDuration(), initialSpeed);
    //setup mask, currently all joints active for entire time
    /** @type {Object<string, number>} */
    this._mask = {};
    /** @type {Object<string, boolean>} */
    this._activeDOFs = {};
    var dofNames = generator.getDOFs();
    var duration = this._clip.getDuration();
    for (var i = 0; i < dofNames.length; i++) {
        this._mask[dofNames[i]] = duration;
        this._activeDOFs[dofNames[i]] = true;
    }
    /** @type {Time} */
    ...
    /** @type {number} */
    this._sourceTimeAtLatestUpdate = 0;
};
VariableSpeedMotionGenerator.prototype = Object.create(MotionGenerator.prototype);
...
VariableSpeedMotionGenerator.prototype.setSpeed = function (newSpeed) {
    this._clip = new RelativeTimeClip(this._sourceTimeAtLatestUpdate, this._clip.getOutPoint(), newSpeed);
    this._latestSpeedChangeTime = this._latestUpdateTime;
    var elapsedTime = this._latestUpdateTime.subtract(this.getStartTime());
    var duration = elapsedTime + this._clip.getDuration();
    var maskKeys = Object.keys(this._mask);
    for (var mki = 0; mki < maskKeys.length; mki++) {
        var maskKey = maskKeys[mki];
        if (this._activeDOFs[maskKey]) {
            this._mask[maskKey] = duration;
        }
    }
};
/**
 ...
 * @override
 */
VariableSpeedMotionGenerator.prototype.getName = function () {
 ...
 * @override
 */
VariableSpeedMotionGenerator.prototype.getStartTime = function () {
    return this._generator.getStartTime();
};
/**
 * @returns {Time}
 * @override
 */
VariableSpeedMotionGenerator.prototype.getEndTime = function () {
    return this.getStartTime().add(this.getDuration());
};
/**
 * @returns {number}
 * @override
 */
VariableSpeedMotionGenerator.prototype.getDuration = function () {
    var longestDuration = 0;
    var maskKeys = Object.keys(this._mask);
    for (var mki = 0; mki < maskKeys.length; mki++) {
        var maskKey = maskKeys[mki];
 ...
 * @override
 */
VariableSpeedMotionGenerator.prototype.getEndTimeForDOF = function (dofName) {
    if (this._mask.hasOwnProperty(dofName)) {
        return this.getStartTime().add(this._mask[dofName]);
    }
    else {
 ...
 * @override
 */
VariableSpeedMotionGenerator.prototype.getDurationForDOF = function (dofName) {
    if (this._mask.hasOwnProperty(dofName)) {
        return this._mask[dofName];
    }
    else {
 ...
 * @override
 */
VariableSpeedMotionGenerator.prototype.cropEnd = function (cropTime, cropMask) {
    var cropMaskKeys;
    if (cropMask != null) {
        cropMaskKeys = cropMask;
    }
    ...
    var croppedDuration = cropTime.subtract(this.getStartTime());
    var cmi;
    if (croppedDuration > 0) {
        for (cmi = 0; cmi < cropMaskKeys.length; cmi++) {
            var cropThisDOF = cropMaskKeys[cmi];
            if (this._mask.hasOwnProperty(cropThisDOF)) {
                if (this._mask[cropThisDOF] > croppedDuration) {
                    this._mask[cropThisDOF] = croppedDuration;
                    this._activeDOFs[cropThisDOF] = false;
                }
            }
        }
    }
        ...
        for (cmi = 0; cmi < cropMaskKeys.length; cmi++) {
            delete this._mask[cropMaskKeys[cmi]];
            this._activeDOFs[cropMaskKeys[cmi]] = false;
        }
    }
    // also crop underlying generator
    if (this.getStartTime().isGreater(cropTime)) {
        this._generator.cropEnd(cropTime, cropMask);
    }
    else {
        var elapsedTime = cropTime.subtract(this._latestSpeedChangeTime);
        var sourceTime = this._clip.getSourceTime(elapsedTime);
        this._generator.cropEnd(this._generator.getStartTime().add(sourceTime), cropMask);
    }
};
/**
 * get all DOFs that are involved in this motion (except for any that
 ...
 * @override
 */
VariableSpeedMotionGenerator.prototype.getDOFs = function () {
    return Object.keys(this._mask);
};
/**
 * @returns {boolean}
 * @override
 */
VariableSpeedMotionGenerator.prototype.hasEntered = function () {
    return this._generator.hasEntered();
};
/**
 * @returns {boolean}
 * @override
 */
VariableSpeedMotionGenerator.prototype.hasExited = function () {
    return this._generator.hasExited();
};
/**
 *
 * @param {Time} currentTime
...
VariableSpeedMotionGenerator.prototype.notifyUpdateStarted = function (currentTime) {
    if (this.getStartTime().isGreater(currentTime)) {
        this._generator.notifyUpdateStarted(currentTime);
    }
    else {
        var elapsedTime = currentTime.subtract(this._latestSpeedChangeTime);
        var sourceTime = this._clip.getSourceTime(elapsedTime);
        this._generator.notifyUpdateStarted(this._generator.getStartTime().add(sourceTime));
        this._latestUpdateTime = currentTime;
        this._sourceTimeAtLatestUpdate = sourceTime;
    }
};
/**
 *
 * @override
 */
VariableSpeedMotionGenerator.prototype.notifyUpdateFinished = function () {
    this._generator.notifyUpdateFinished();
};
/**
 *
 * @override
 ...
 * @override
 */
VariableSpeedMotionGenerator.prototype.getDOFState = function (dofName, partialRender, blackboard) {
    return this._generator.getDOFState(dofName, partialRender, blackboard);
};
module.exports = VariableSpeedMotionGenerator;

},{"../../ifr-motion/base/RelativeTimeClip":77,"./MotionGenerator":15}],23:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
...
},{"../ifr-core/SLog":54,"../ifr-core/Time":55}],24:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
 ...
 */
BodyOutput.prototype.setPaused = function (shouldPause) {
...
},{"../ifr-core/TimerTools":56,"./MotionInterface":32}],25:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
...
},{"../ifr-core/Clock":50,"./BodyData":23,"./BodyOutput":24}],26:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
 ...
 * @override
 */
BodyPosVelOutput.prototype.setPaused = function (shouldPause) {
    BodyOutput.prototype.setPaused.call(this, shouldPause);
    if (shouldPause) {
        this.startTime = null;
        this.initialDeltas = [];
...
BodyPosVelOutput.prototype.update = function () {
    ...
    if (targets !== null && this.motionInterface.isConnected() && !this.isPaused()) {
        if (this.startTime === null) {
            ...
            var currentState;
            //first check if it is ok to soft start (no joint is moving fast)
            for (i = 0; i < this.dofNames.length; i++) {
                currentState = this.motionInterface.getState(this.dofNames[i]);
                var targetState = targets[i];
                if (Math.abs(currentState.vel) > 0.2 || Math.abs(targetState.velocity) > 0.2) {
                    //console.log("BodyPosVelOutput: Delaying soft start due to motion in target or current position. current:"+currentState.vel+"  target:"+targetState.velocity);
                    okToSoftStart = false;
                    break;
                }
            }
            if (okToSoftStart) {
                ...
                for (i = 0; i < this.dofNames.length; i++) {
                    ...
                    this.initialDeltas.push(currentTarget - currentState.pos);
                }
            }
        }
        //if start time is still null, we have elected to wait longer before starting our soft-start
        if (this.startTime !== null) {
            var fadeAlpha = 1;
            var fadeSecondsMax = 8;
            var fadeSeconds = fadeSecondsMax;
            if (currentTime.subtract(this.startTime) < fadeSecondsMax) {
                var maxDistance = 0;
                for (i = 0; i < this.dofNames.length; i++) {
                    if (Math.abs(this.initialDeltas[i]) > maxDistance) {
                        maxDistance = Math.abs(this.initialDeltas[i]);
                    }
                }
                maxDistance = Math.max(0, Math.min(Math.PI, maxDistance));
                fadeSeconds = fadeSecondsMax * (maxDistance / Math.PI);
                fadeAlpha = currentTime.subtract(this.startTime) / fadeSeconds;
                fadeAlpha = Math.max(0, Math.min(1, fadeAlpha));
            }
            for (i = 0; i < this.dofNames.length; i++) {
                var commandMode = this.enabledArray[i] ? BodyData.AxisCommandMode.POS_VEL : BodyData.AxisCommandMode.BRAKE;
                if (this.error && this.goLimpOnError) {
                    commandMode = BodyData.AxisCommandMode.BRAKE;
                }
                var accelerationLimit = 50;
                var command;
                if (fadeAlpha < 1) {
                    var velocityCatchupContribution = this.initialDeltas[i] / fadeSeconds;
...
},{"../ifr-motion/base/CyclicMath":67,"./BodyData":23,"./BodyOutput":24}],27:[function(require,module,exports){
/**
...
},{"./BodyOutput":24}],28:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
...
},{"./BodyData":23,"./BodyOutput":24}],29:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
...
},{"../ifr-motion/feedback/PVController":91,"./BodyData":23,"./BodyOutput":24}],30:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
...
},{"../ifr-core/Clock":50,"../ifr-core/ReconnectingWebSocket":53,"./BodyData":23}],31:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
...
},{"../ifr-core/TimerTools":56,"./LEDInterface":30}],32:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
...
},{"../ifr-core/Clock":50,"../ifr-core/ReconnectingWebSocket":53,"./BodyData":23}],33:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
...
},{"../ifr-core/FileTools":51,"../ifr-core/Time":55}],34:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
...
},{"./BodyOutput":24}],35:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
...
},{"./RenderPlugin":39,"three":undefined}],37:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
...
},{"../ifr-geometry/loaders/ArticulatedModelLoader":60,"../ifr-motion/dofs/TextureControl":87,"../ifr-motion/loaders/KinematicsLoader":95,"three":undefined}],38:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
...
},{"../ifr-geometry/loaders/ArticulatedModelLoader":60,"../ifr-motion/dofs/TextureControl":87,"../ifr-motion/loaders/KinematicsLoader":95,"three":undefined}],39:[function(require,module,exports){
/**
 * @author jg
 */
"use strict";
...
},{"../ifr-core/SLog":54,"three":undefined}],40:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
...
},{"../geometry-info/SceneInfo":48,"../ifr-core/SLog":54,"../ifr-geometry/loaders/CachedImageLoader":61,"../ifr-visualizer/BasicScene":121,"./DefaultEyeLighting":36,"./JiboBody":37,"./JiboEye":38,"three":undefined}],42:[function(require,module,exports){
/**
 * @author jg
 */
"use strict";
...
},{"../ifr-core/FileTools":51,"../ifr-core/SLog":54}],43:[function(require,module,exports){
/**
 * @author jg
...
},{"../ifr-motion/dofs/TranslationControl":88}],44:[function(require,module,exports){
/**
 * @author jg
 */
"use strict";
...
},{"../ifr-core/SLog":54,"../ifr-geometry/loaders/SkeletonLoader":63,"../ifr-motion/base/DOFGlobalAlignment":68,"../ifr-motion/base/InterpolatorSet":69,"../ifr-motion/base/Pose":76,"../ifr-motion/base/SeriesAlignedAxesTargetSelector":78,"../ifr-motion/dofs/KinematicGroup":82,"../ifr-motion/dofs/ModelControlGroup":85,"../ifr-motion/loaders/AnimationLoader":94,"../ifr-motion/loaders/KinematicsLoader":95,"../ifr-motion/loaders/LimitsLoader":96,"./DOFSet":42,"./EyeScreenInfo":44,"./SceneInfo":48}],47:[function(require,module,exports){
/**
 * @author jg
 */
"use strict";
...
},{"../ifr-core/SLog":54,"./JiboConfig":45,"./JiboKinematicInfo":46}],48:[function(require,module,exports){
/**
 * @author mattb
 */
"use strict";
...
},{"../ifr-core/FileTools":51}],49:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
...
},{"./SLog":54}],50:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
...
},{"./Time":55}],51:[function(require,module,exports){
/**
 * @author mattb
 * Copyright 2015 IF Robots LLC
 */
...
},{"urijs":undefined}],52:[function(require,module,exports){
/**
 * @author mattb
 * Copyright 2016 IF Robots LLC
 */
...
},{"./FileTools":51,"./SLog":54}],53:[function(require,module,exports){
/**
 * @author mattb
 * Copyright 2016 IF Robots LLC
 */
...
},{"./SLog":54}],54:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
...
},{"three":undefined}],58:[function(require,module,exports){
/**
 * @author mattb
 * Copyright 2014 IF Robots LLC
 */
...
},{"./ModelLoader":62,"./SkeletonLoader":63,"three":undefined}],61:[function(require,module,exports){
/**
 * @author mattb
 * Copyright 2014 IF Robots LLC
 */
...
},{"../../ifr-core/FileTools":51,"../BasicFrame":57,"../BasicMesh":58,"three":undefined}],63:[function(require,module,exports){
/**
 * @author mattb
 * Copyright 2014 IF Robots LLC
 */
...
},{"../../ifr-core/FileTools":51,"../BasicFrame":57,"three":undefined}],64:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
...
},{"../../ifr-core/SLog":54}],65:[function(require,module,exports){
/**
 * @author mattb
 * Copyright 2015 IF Robots LLC
 */
...
},{"./Motion":71,"./MotionEvent":72}],66:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
...
},{"./CyclicMath":67}],67:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
...
},{"./CyclicDOFTargetSelector":66}],69:[function(require,module,exports){
/**
 * @author mattb
 * Copyright 2015 IF Robots LLC
 */
...
},{"../dofs/TextureControl":87,"../dofs/VisibilityControl":89,"./Interpolators":70}],70:[function(require,module,exports){
/**
 * @author mattb
 * Copyright 2015 IF Robots LLC
 */
...
},{"./MotionTrack":74,"./Pose":76,"./TimestampedBuffer":79}],72:[function(require,module,exports){
/**
 * @author mattb
 * Copyright 2015 IF Robots LLC
 */
...
},{"./Motion":71,"./MotionTrack":74}],76:[function(require,module,exports){
/**
...
},{"./CyclicDOFTargetSelector":66,"./CyclicMath":67}],79:[function(require,module,exports){
/**
 * @author mattb
 * Copyright 2015 IF Robots LLC
 */
...
},{"./ModelControl":83,"./ModelControlFactory":84,"three":undefined}],81:[function(require,module,exports){
/**
 * @author mattb
 * Copyright 2015 IF Robots LLC
 */
...
},{"./DOFInfo":81,"./KinematicGroup":82}],86:[function(require,module,exports){
/**
 * @author mattb
 * Copyright 2014 IF Robots LLC
 */
...
},{"../../ifr-geometry/BasicFrame":57,"./ModelControl":83,"./ModelControlFactory":84,"three":undefined}],87:[function(require,module,exports){
/**
 * @author mattb
 * Copyright 2014 IF Robots LLC
 */
...
},{"../../ifr-core/SLog":54,"../../ifr-geometry/loaders/CachedImageLoader":61,"./ModelControl":83,"./ModelControlFactory":84,"three":undefined}],88:[function(require,module,exports){
/**
 * @author mattb
 * Copyright 2014 IF Robots LLC
 */
...
},{"../../ifr-geometry/BasicFrame":57,"./ModelControl":83,"./ModelControlFactory":84,"three":undefined}],89:[function(require,module,exports){
/**
 * @author mattb
 * Copyright 2016 IF Robots LLC
 */
...
},{"../../ifr-core/SLog":54,"./ModelControl":83,"./ModelControlFactory":84}],90:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
...
},{"../../ifr-core/Bakery":49,"../base/CyclicMath":67}],91:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
...
},{"../../ifr-core/Bakery":49,"./PController":90}],92:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
...
},{"./TrajectoryControllerSim":93}],93:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
...
},{"../../ifr-core/Clock":50,"../../ifr-core/SLog":54,"../base/AccelPlanner":64,"../base/CyclicMath":67}],94:[function(require,module,exports){
/**
 * @author mattb
 * Copyright 2015 IF Robots LLC
 */
...
},{"../../ifr-core/FileTools":51,"../../ifr-core/SLog":54,"../base/Motion":71,"../base/MotionEvent":72,"../base/MotionTrack":74,"../base/TimestampedBuffer":79}],95:[function(require,module,exports){
/**
 * @author mattb
 * Copyright 2014 IF Robots LLC
 */
...
},{"../../ifr-core/FileTools":51,"../dofs/ColorControl":80,"../dofs/ModelControlGroup":85,"../dofs/RotationControl":86,"../dofs/TextureControl":87,"../dofs/TranslationControl":88,"../dofs/VisibilityControl":89}],96:[function(require,module,exports){
/**
 * @author mattb
 * Copyright 2015 IF Robots LLC
 */
...
},{"../../ifr-core/FileTools":51,"../../ifr-core/SLog":54}],97:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
...
},{"../../ifr-core/SLog":54,"../base/CyclicMath":67,"../base/Pose":76}],98:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2016 IF Robots LLC
 */
...
},{"../../ifr-core/SLog":54,"../../ifr-geometry/ExtraMath":59,"./PlaneDisplacementLookatDOF":108,"three":undefined}],99:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2016 IF Robots LLC
 */
...
},{"./trackpolicy/LookatNodeTrackPolicy":114}],100:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
...
var LookatMotionNode = function (lookatNode, dofAligner, accel, stabilizer, stabilizationMode, trackPolicy, blinkManager, targetAdjuster, windupPolicy) {
    ...
    this._filter = new PoseOffsetFilterWindup(lookatNode.getDOFs());
     ...
     * @type {Pose}
     */
    this._currentPoseIncludingOurContribution = new Pose("Current Include Us");
    ...
    if (targetAdjuster != null) {
        ...
        this._adjustedOptimalPose = new Pose("LMN Adjusted Optimal", lookatNode.getDOFs());
    }
    /** @type {DOFGlobalAlignment} */
...
LookatMotionNode.prototype.update = function (currentPose, inplaceOutput, target, time) {
    ...
    if (this._stabilizationMode !== LookStabilizationMode.UNTARGETED) {
    ...
    if (this._lastUpdateTime === null) {
        ...
        if (this._lookatWindupPolicy !== null) {
            var shouldTriggerWindup = this._lookatWindupPolicy.shouldWindup(this._lookatNodeDistanceReport, trackMode, time, target);
        ...
        if (this._blinkManager !== null) {
            ...
            this._blinkManager.update(this._lookatNodeDistanceReport, trackMode, windupState, time);
        }
        if (updateHoldPose) {
...
},{"../../ifr-core/SLog":54,"../base/Pose":76,"./LookatNode":102,"./LookatNodeDistanceReport":103,"./PoseOffsetFilterWindup":111,"./trackpolicy/LookatNodeTrackPolicy":114,"./trackpolicy/TrackPolicyTriggerAlways":116,"three":undefined}],102:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
...
},{"../../ifr-core/SLog":54,"./PointADOF":109}],103:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
...
LookatNodeDistanceReport.prototype.compute = function (holdPose, optimalPose, filteredOutput) {
    ...
    for (var i = 0; i < dofNames.length; i++) {
        ...
        var velocityFiltered = Math.abs(filteredOutput.get(dofName, 1));
...
},{"../base/Pose":76}],105:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2016 IF Robots LLC
 */
...
},{"../base/Pose":76}],107:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
...
var OcularStabilizationTracker = function (lookatNode, dofAligner) {
    ...
    this.computeStabilizationDelta = function (currentPose, optimalPoseForCurrentTarget, currentTarget) {
        if (initialized) {
            var report = new LookatNode.PointNodeReport(); //TODO: if target has not changed, isn't optimalPoseForCurrentTarget == newOptimalPoseForLastTarget?
    ...
    this.decomposeVelocity = function (currentPose, inplacePostStabilizationPose, target, rejectionVelocityThreshold) {
        ...
        for (var i = 0; i < dofNames.length; i++) {
            ...
            if (rejectionVelocityThreshold !== 0 && Math.abs(stabilizationVelocity) > rejectionVelocityThreshold) {
                slog.error("Clamping OST application of stabilization velocity of " + stabilizationVelocity + " to " + dofName + " as it is greater than " + rejectionVelocityThreshold);
...
},{"../../ifr-core/SLog":54,"../base/Pose":76,"./LookatNode":102,"three":undefined}],108:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
...
},{"./LookatDOF":100,"./PointADOF":109}],109:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
...
},{"../../ifr-core/SLog":54,"../../ifr-geometry/ExtraMath":59,"three":undefined}],110:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
 ...
 * @protected
 */
PoseOffsetFilter.prototype._timeForLongestDOF = function (targetPose, filteredPose, accelPlanner, accLimit, dofNames) {
    /** @type {string} */
    var dofName;
    /** @type {number} */
 ...
 * @protected
 */
PoseOffsetFilter.prototype._advanceFixedTimeMode = function (advanceSeconds, totalTransitTime, targetPose, filteredPose, accelPlanner, dofNames) {
    /** @type {string} */
    var dofName;
    /** @type {number} */
    var currentPos, currentVel;
    ...
    if (totalTransitTime > this._epsilon) {
        for (var i = 0; i < dofNames.length; i++) {
            ...
            if (myPlan && myPlan.isConsistent()) {
                ...
                slog(channel, "PoseOffsetFilter(dp) for " + dofName + " got invalid plan, using backup filter! (currentVel:" + currentVel + ", target:" + target + ", currentPos:" + currentPos + ", totalTransitTime:" + totalTransitTime + ")");
...
PoseOffsetFilter.prototype.updateByTime = function (seconds) {
    var transitionTime = this._timeForLongestDOF(this._targetPose, this._filteredPose, this._accelPlanner, this._accLimit, this._dofNames);
    this._advanceFixedTimeMode(seconds, transitionTime, this._targetPose, this._filteredPose, this._accelPlanner, this._dofNames);
};
...
PoseOffsetFilter.prototype.applyUnfilteredOffset = function (deltaPose, deltaTime) {
    ...
    for (var i = 0; i < dofNames.length; i++) {
        ...
        if (applyDeltaThreshold && Math.abs(dVal) > rejectionDeltaThreshold) {
            slog.error("PoseOffsetFilter:Clamping application of unfiltered offset of " + dVal + " to " + dofName + " as it is greater than " + rejectionDeltaThreshold);
            if (dVal < 0) {
...
},{"../../ifr-core/SLog":54,"../base/AccelPlanner":64,"../base/Pose":76}],111:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
 ...
 */
var checkTrajectoryStartCriteria = function (targetPose, filteredPose, dofNames, maxAllowedTriggerSpeed, minAllowedTriggerDistance, maxAllowedTriggerDistance) {
    var maxDOFVelocity = 0;
    var maxDOFDistance = 0;
    //get current velocity and distance to target
    for (var i = 0; i < dofNames.length; i++) {
        var dofName = dofNames[i];
        var currentVelAbs = Math.abs(filteredPose.get(dofName, 1));
        var dofDistance = Math.abs(filteredPose.get(dofName, 0) - targetPose.get(dofName, 0));
 ...
 * @param {string[]} dofNames - dofnames for easier iterating
 * @returns {number} time to accelerate away from target to achieve windup
 */
var computeWindupTime = function (windupAccelerations, totalDistance, windupDistanceRatio, windupMinDistance, windupMaxDistance, dofNames) {
    /** @type {?string} */
    var dofName = null;
    /** @type {number} */
    var i;
    ...
    for (i = 0; i < dofNames.length; i++) {
        dofName = dofNames[i];
        var thisDOFAccel = windupAccelerations.get(dofName, 0);
 ...
 */
var computeTotalDistanceToTarget = function (targetPose, filteredPose, inplacePerDOFDistances, dofNames, epsilon) {
    /** @type {number} */
    var totalDistance = 0;
    for (var i = 0; i < dofNames.length; i++) {
        var dofName = dofNames[i];
        var currentPos = filteredPose.get(dofName, 0);
        var target = targetPose.get(dofName, 0);
        ...
        inplacePerDOFDistances.set(dofName, delta, 0);
        if (delta !== 0) {
 ...
 * @param {number} epsilon
 */
var computeWindupAccelerations = function (totalTransitTime, targetPose, filteredPose, accelPlanner, inplaceWindupAccelerations, dofNames, epsilon) {
    /** @type {?string} */
    var dofName = null;
    /** @type {number} */
    var i;
    ...
    for (i = 0; i < dofNames.length; i++) {
        ...
        if (totalTransitTime > epsilon) {
            var currentPos = filteredPose.get(dofName, 0);
            var currentVel = filteredPose.get(dofName, 1);
            var target = targetPose.get(dofName, 0);
            ...
            if (myPlan && myPlan.isConsistent()) {
                ...
                inplaceWindupAccelerations.set(dofName, -myInitialAccel, 0);
            }
            else {
                slog(channel, "PoseOffsetFilter(cwa) for " + dofName + " got invalid plan, dof will have no windup! (currentVel:" + currentVel + ", target:" + target + ", currentPos:" + currentPos + ", totalTransitTime:" + totalTransitTime + ")");
                //should never happen, but still need to act...  skip windup on this dof.
                inplaceWindupAccelerations.set(dofName, 0, 0);
            }
        }
        else {
 ...
 * @param {number} epsilon
 */
var scaleOvershootDelta = function (inplaceOvershootDeltas, totalDistanceToTarget, dofNames, overshootDistanceRatio, overshootMinDistance, overshootMaxDistance, epsilon) {
    /** @type {?string} */
    var dofName = null;
    /** @type {number} */
    var i;
    ...
    if (totalDistanceToTarget > epsilon && overshootDistanceRatio !== 0) {
        ...
        for (i = 0; i < dofNames.length; i++) {
            dofName = dofNames[i];
            inplaceOvershootDeltas.set(dofName, inplaceOvershootDeltas.get(dofName, 0) * overshootScale, 0);
        }
    }
    else {
        ...
        for (i = 0; i < dofNames.length; i++) {
            dofName = dofNames[i];
            inplaceOvershootDeltas.set(dofName, 0, 0);
        }
    }
};
/**
 ...
 * @protected
 */
PoseOffsetFilterWindup.prototype._advanceFixedTimeModeWindup = function (advanceSeconds, totalTransitTime, targetPose, filteredPose, accelPlanner, windupAccel, dofNames) {
    /** @type {string} */
    var dofName = null;
    /** @type {number} */
    var i = 0;
    ...
    if (this._windupTimeRemaining > 0) {
        ...
        for (i = 0; i < dofNames.length; i++) {
            ...
            currentPos = filteredPose.get(dofName, 0);
            var currentVel = filteredPose.get(dofName, 1);
            var useAccel = windupAccel.get(dofName, 0);
            ...
            filteredPose.set(dofName, [currentPos + windupDisplacement, windupNewVelocity]);
        }
    }
    if (advanceSeconds > this._epsilon) {
        this._advanceFixedTimeMode(advanceSeconds, totalTransitTime, targetPose, filteredPose, accelPlanner, dofNames);
    }
};
/**
...
PoseOffsetFilterWindup.prototype.updateByTime = function (seconds) {
    ...
    if (this._weAreOvershooting) {
        ...
        for (var i = 0; i < dofNames.length; i++) {
            var dofName = dofNames[i];
            var overshootDelta = this._targetOvershootDelta.get(dofName, 0);
            var unmodifiedTarget = this._targetPose.get(dofName, 0);
            var currentPos = this._filteredPose.get(dofName, 0);
            ...
            if ((deltaToTarget > 0 && overshootDelta > 0) || (deltaToTarget < 0 && overshootDelta < 0)) {
                ...
                this._overshootModifiedTarget.set(dofName, unmodifiedTarget + overshootDelta, 0);
            }
            else {
                this._overshootModifiedTarget.set(dofName, unmodifiedTarget, 0);
            }
        }
    ...
    var transitionTime = this._timeForLongestDOF(useTarget, this._filteredPose, this._accelPlanner, this._accLimit, dofNames);
    if (this._shouldStartWindup) {
        ...
        this._shouldStartWindup = false;
        var okToStart = checkTrajectoryStartCriteria(this._targetPose, this._filteredPose, this._dofNames, this._maxAllowedTriggerSpeed, this._minAllowedTriggerDistance, this._maxAllowedTriggerDistance);
        if (okToStart) {
            var totalDistance = computeTotalDistanceToTarget(this._targetPose, this._filteredPose, this._targetOvershootDelta, this._dofNames, this._epsilon);
            if (this._overshootDistanceRatio > 0) {
                scaleOvershootDelta(this._targetOvershootDelta, totalDistance, this._dofNames, this._overshootDistanceRatio, this._overshootMinDistance, this._overshootMaxDistance, this._epsilon);
                this._weAreOvershooting = true;
            }
            if (this._windupDistanceRatio !== 0) {
                computeWindupAccelerations(transitionTime, this._targetPose, this._filteredPose, this._accelPlanner, this._windupAccel, dofNames, this._epsilon);
                this._windupTimeRemaining = computeWindupTime(this._windupAccel, totalDistance, this._windupDistanceRatio, this._windupMinDistance, this._windupMaxDistance, this._dofNames);
    ...
    this._advanceFixedTimeModeWindup(seconds, transitionTime, useTarget, this._filteredPose, this._accelPlanner, this._windupAccel, dofNames);
};
module.exports = PoseOffsetFilterWindup;

},{"../../ifr-core/SLog":54,"../base/Pose":76,"./PoseOffsetFilter":110}],112:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
...
},{"./LookatDOF":100,"./PointADOF":109,"three":undefined}],113:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
...
},{"../../ifr-geometry/ExtraMath":59,"../../ifr-motion/base/CyclicMath":67,"./LookatDOF":100,"./PointADOF":109,"three":undefined}],114:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
...
},{"./TrackPolicyTrigger":115}],115:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2016 IF Robots LLC
 */
...
},{"./TrackPolicyTrigger":115}],117:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2016 IF Robots LLC
 */
...
},{"./TrackPolicyTrigger":115}],118:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2016 IF Robots LLC
 */
...
},{"./TrackPolicyTrigger":115}],119:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2016 IF Robots LLC
 */
...
},{"./TrackPolicyTrigger":115}],120:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2016 IF Robots LLC
 */
...
},{"./GLLinePool":122,"three":undefined}],121:[function(require,module,exports){
/**
 * @author mattb
 * Copyright 2014 IF Robots LLC
 */
...
},{"./TrackballControls":127,"stats-js":undefined,"three":undefined}],122:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
...
},{"three":undefined}],123:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2016 IF Robots LLC
 */
...
},{"./MouseCoordinateWrangler":124,"./TextOverlayPool":126}],124:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
...
},{"../ifr-core/SLog":54,"three":undefined}],125:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2015 IF Robots LLC
 */
...
},{"../ifr-core/SLog":54,"./MouseCoordinateWrangler":124,"./ViewportTargetPositioner":128,"three":undefined}],126:[function(require,module,exports){
/**
 * @author jg
 * Copyright 2016 IF Robots LLC
 */
...
},{"../ifr-core/SLog":54,"./AnchoredTargetVisualizer":120,"./MouseCoordinateWrangler":124,"three":undefined}],129:[function(require,module,exports){
"use strict";
...
},{"./animation-animate/AnimateImpl":2,"./animation-animate/timeline/AuxOutput":7,"./animation-animate/timeline/SampleCombiner":17,"./animation-body/BodyPosVelComboOutput":25,"./animation-body/BodyPosVelOutput":26,"./animation-body/BodyPositionOutput":27,"./animation-body/BodyTrajectoryOutput":28,"./animation-body/BodyVelocityOutput":29,"./animation-body/LEDOutput":31,"./animation-body/MotionInterface":32,"./animation-body/MotionLog":33,"./animation-body/MotionServiceOutput":34,"./animation-macros/TimelineBuilder":35,"./animation-visualize/RenderPlugin":39,"./animation-visualize/VisualizeImpl":41,"./geometry-info/EyeKinematicsHelper":43,"./geometry-info/JiboConfig":45,"./geometry-info/RobotInfo":47,"./ifr-core/Bakery":49,"./ifr-core/Clock":50,"./ifr-core/FileTools":51,"./ifr-core/JSONBaker":52,"./ifr-core/SLog":54,"./ifr-core/Time":55,"./ifr-motion/feedback/PosVelControllerSim":92,"./ifr-motion/feedback/TrajectoryControllerSim":93,"./ifr-visualizer/AnchoredTargetVisualizer":120,"./ifr-visualizer/GLLinePool":122,"./ifr-visualizer/GLTextOverlayPool":123,"./ifr-visualizer/MouseCoordinateWrangler":124,"./ifr-visualizer/MouseTargetPositioner":125,"three":undefined}]},{},[129])(129)
});
