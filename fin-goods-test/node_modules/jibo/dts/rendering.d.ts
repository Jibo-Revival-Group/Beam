...
declare namespace rendering {
    ...
    export namespace gui {
        ...
        export abstract class Component extends EventEmitter {
            ...
            protected _actions:actions.ActionData[];
            ...
            public addAction(type:string, data?:any, clearPrevious?:boolean, toFront?:boolean):actions.ActionData;
            public addAction(actionData:actions.ActionData, clearPrevious?:boolean, toFront?:boolean):actions.ActionData;
        ...
        export namespace components {
            ...
            export class List extends ComponentGroup {
                ...
                public calculateReferenceValues():void;
                public updateConfig(configData:any):any;
                public createDisplay(container:PIXI.Container, assets?:any):void;
                public setupDisplay(assets?:any):void;
                public ready():void;
        ...
        export class ComponentCreator {
            ...
            public createViewFromConfigPath(configPath:string, callback:(view:views.View) => any):void;
        ...
        export class ViewManager {
            static TRANS_UP:string;
            static TRANS_DOWN:string;
            static TRANS_RIGHT:string;
            static TRANS_LEFT:string;
            static TRANS_IN:string;
            static TRANS_OUT:string;
            ...
            public forceEyeView(onOpenCallback?:ViewCallback, onPressCallback?:any, openTransition?:string, closeTransition?:string):void;
    ...
    export namespace input {
        ...
        export class GestureManager {
            hammer: typeof HammerJS;
            addStageGesture(displayObject:PIXI.DisplayObject, hammerType:any, gestureOptions:any, gestureCallback: (hammerEvent:{}) => void):any;
            removeStageGesture(gestureRecognizer):void;
        }
        // endregion input
    }
    ...
    export namespace eye {
        ...
        abstract class AbstractEye extends PIXI.Container {
            eyeMesh:EyeMesh;
            ...
            blue:number;
            destroy():void;
            abstract update(timestamp:number[], dofValues:DOFValues):void;
        }
