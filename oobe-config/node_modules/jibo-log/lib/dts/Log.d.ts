...
import { Level, LoggingConfig, Output } from './types';
/**
...
declare class Log {
    ...
    private readonly _outputConfig;
    private static LogOutputs;
    private static types;
    private static Level;
    private static Output;
    private static ConsoleHandler;
    private static SyslogHandler;
    private static FileHandler;
}
export default Log;
export { OutputPerNamespace, LevelPerOutput };
