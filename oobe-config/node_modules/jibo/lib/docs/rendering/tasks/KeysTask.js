 ...
 */
     ...
     * @method jibo.loader.KeysTask#createAnimOptions
     * @return {Promise<AnimationOptions<DOFSet>>}
     * @private
     */

    /**
     * Creates the instance from the options object.
     * @param {AnimationOptions<DOFSet>} options
     * @return {Promise<AnimationInstance>}
     * @private
     * @method jibo.loader.KeysTask#createInstance
     */