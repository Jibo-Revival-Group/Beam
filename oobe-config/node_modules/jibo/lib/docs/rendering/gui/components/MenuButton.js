 ...
 * @prop {PIXI.Point} dimensions - Width and height of button.
 ...
 */
     ...
     * Use when applying scaling.
     * @name jibo.face.views.MenuButton#buttonDisplay
     * @type {PIXI.Container}
     * @readOnly
     */
     ...
     * @name jibo.face.views.MenuButton#DOWN_SCALE
     * @type {number}
     * @private
     */
     ...
     * @name jibo.face.views.MenuButton#ACTIVATE_SCALE
     * @type {number}
     * @private
     */
     ...
     * @name jibo.face.views.MenuButton#TWEEN_TIME
     * @type {number}
     * @private
     */
     ...
     * @param {PIXI.Point} dimensions - Width and height of button.
     ...
     * @method jibo.face.views.MenuButton#emptyDisplay
     */

    /**
     * Set up new icon/clip in a button. Remove any pre-existing icon/clip.
     ...
     * @method jibo.face.views.MenuButton#activate
     */
