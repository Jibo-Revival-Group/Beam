 ...
 */
export declare type AnimMetadataMap = {
 ...
 */
export declare type KeyValueAnimMetadataArray = [string, AnimMetadata][];
/**
 * @class AnimDBParser
...
export declare class AnimDBParser {
     ...
     */
    static addAnimCollection(animDB: AnimDB, rootDir: string, animMetaMap: AnimMetadataMap): void;
    /**
     ...
     */
    static addToAnimCollection(collection: AnimCollection, rootDir: string, animMetadataCollection: KeyValueAnimMetadataArray | AnimMetadataMap): void;
    /**
     ...
     */
    static createAnimMetaData(jibo: any, rootDir: string): Promise<AnimMetadataMap>;
    /**
     ...
     */
    static _createAnimMetaData(jibo: any, rootDir: string, paths: string[]): Promise<AnimMetadataMap>;
    /**
     ...
     */
    static parseAnimation(jibo: any, filePath: string, rootDir?: string): Promise<AnimMetadata>;
    /**
     ...
     */
    static loadKeys(jibo: any, keysPath: string, rootDir?: string): Promise<Anim>;
    /**
