...
var BodyLayer_1 = require("./layers/BodyLayer");
var EyeLayer_1 = require("./layers/EyeLayer");
var OverlayLayer_1 = require("./layers/OverlayLayer");
var EyeTextureLayer_1 = require("./layers/EyeTextureLayer");
var OverlayTextureLayer_1 = require("./layers/OverlayTextureLayer");
var BackgroundTextureLayer_1 = require("./layers/BackgroundTextureLayer");
var LEDLayer_1 = require("./layers/LEDLayer");
var PixiLayer_1 = require("./layers/PixiLayer");
var EventLayer_1 = require("./layers/EventLayer");
var AudioLayer_1 = require("./layers/AudioLayer");
var ReferenceLayer_1 = require("./layers/ReferenceLayer");
...
var JiboKeyframeInfo = (function () {
     ...
     */
    JiboKeyframeInfo.onLoad = function (keyframes) {
 ...
 */
var fs = require("fs");
var lodash_min_1 = require("lodash/lodash.min");
var Tweening_1 = require("./utils/Tweening");
var IDUtils_1 = require("./utils/IDUtils");
var Search_1 = require("./utils/Search");
var BlendOperations_1 = require("./utils/BlendOperations");
var Runtime = (function () {
     ...
     *
     */
    Runtime.create = function (keyframeInfo) {
        var keyframes = {
     ...
     */
    Runtime.load = function (uri, keyframeInfo) {
        var keyframes = JSON.parse(fs.readFileSync(uri, 'utf8'));
     ...
     */
    Runtime.save = function (uri, keyframes) {
    ...
    Runtime._isEventLayer = function (layer, keyframeInfo) {
        if (layer) {
     ...
     */
    Runtime.evaluateAllDOFLayers = function (keyframes, keyframeInfo, timeInSeconds, overrides) {
     ...
     * @returns {boolean}
     */
    Runtime.isReferencedLayer = function (layer) {
     ...
     * @returns {boolean}
     */
    Runtime.hasReferencedLayersOfType = function (keyframes, type) {
        for (var i = 0; i < keyframes.layers.length; i++) {
     ...
     * @returns {*}
     */
    Runtime.evaluateAllLayersFiltered = function (keyframes, keyframeInfo, timeInSeconds, includeFilter, provideDefaults, overrides) {
        var _this = this;
        ...
        if (!this.hasReferencedLayersOfType(keyframes, 'Eye')) {
            return this.evaluateLayersFiltered(keyframes, keyframeInfo, timeInSeconds, includeFilter, provideDefaults, overrides);
        }
        // "Blink layer mode" combines the Eye and Overlay in the Top and Reference layers in a particular way.
        var hasNoReferencedOverlays = !this.hasReferencedLayersOfType(keyframes, 'Overlay');
        var topFilter = function (layer) {
            return includeFilter(layer) && !_this.isReferencedLayer(layer) && layer.type === 'Eye';
        };
        var refFilter = function (layer) {
            return includeFilter(layer) && _this.isReferencedLayer(layer) && (layer.type === 'Eye' || layer.type === 'Overlay');
        };
        var otherFilter = function (layer) {
        ...
        var ref = this.evaluateLayersFiltered(keyframes, keyframeInfo, timeInSeconds, refFilter, overrides);
        ...
        var accumulatedProps = this.evaluateLayersFiltered(keyframes, keyframeInfo, timeInSeconds, otherFilter, overrides);
        // Gather up the Eye properties from the top layer.
        var top = this.evaluateLayersFiltered(keyframes, keyframeInfo, timeInSeconds, topFilter, overrides);
        var eyeLayerInfo = keyframeInfo.layerTypes['Eye'].getInfo();
        // Then form the final Eye and Overlay props by combining the referenced layers with the top Eye layer.
        for (var _i = 0, _a = ['Eye', 'Overlay']; _i < _a.length; _i++) {
            var refLayerType = _a[_i];
            if (ref[refLayerType]) {
                ...
                if (top['Eye']) {
                    for (var prop in eyeLayerInfo.properties) {
                        var propInfo = eyeLayerInfo.properties[prop];
                        var blendOp = BlendOperations_1.default.normal(propInfo.blendOperation, propInfo.type);
    ...
    Runtime.evaluateLayersFiltered = function (keyframes, keyframeInfo, timeInSeconds, includeFilter, provideDefaults, overrides) {
        ...
        for (var i = keyframes.layers.length - 1; i >= 0; i--) {
            ...
            var override = overrides === undefined ? undefined : overrides[layer.id], props = Runtime.evaluateLayer(layer, keyframes, keyframeInfo, timeInSeconds, override);
            ...
            if (typeof accumulatedProps[layerType] === "undefined") {
                ...
                var layerProps = accumulatedProps[layerType], layerInfo = keyframeInfo.layerTypes[layerType].getInfo();
    ...
    * */
    Runtime.computeRelativePropValues = function (excludedLayer, keyframes, keyframeInfo, timeInSeconds, absoluteProps, overrides) {
        ...
        var layerInfo = keyframeInfo.layerTypes[excludedLayer.type].getInfo(), relativeProps = {};
     ...
     */
    Runtime.evaluateLayer = function (layer, keyframes, keyframeInfo, timeInSeconds, override) {
        ...
        var currentTime = timeInSeconds * keyframes.framerate;
        ...
        var _a = Search_1.default.keyframeSearch(layer.keyframes, currentTime), start = _a.start, end = _a.end;
        ...
        var timeStart = start.time, timeEnd = end.time, timeNormalized = (currentTime - timeStart) / (timeEnd - timeStart);
        var easingFunction = 'cubicInOut';
        if (start.value.Tween) {
            easingFunction = start.value.Tween.value;
        }
        for (var propName in start.value) {
            var tweenType = layerTypeInfo.properties[propName].type;
    ...
    Runtime._evaluateEventLayer = function (layer, keyframes, keyframeInfo, timeInSeconds) {
        ...
        var frame = Search_1.default.keyframeSearchAbsolute(layer.keyframes, keyframeTime);
        if (frame !== undefined) {
     ...
     */
    Runtime.evaluateAllEventLayers = function (keyframes, keyframeInfo, timeInSeconds) {
        var events = [];
        ...
        for (var i = 0; i < layersLen; i++) {
            ...
            if (props) {
                ...
                var eventType = (typeof generatedEvent);
...
var DOFBaseLayer = (function (_super) {
    __extends(DOFBaseLayer, _super);
     ...
     */
    DOFBaseLayer.generateDofs = function () {
        throw "Implement static Layer.generateDofs()";
    };
    DOFBaseLayer.isEvent = function () {
        return false;
    };
    return DOFBaseLayer;
}(BaseLayer_1.default));
...
Object.defineProperty(exports, "__esModule", { value: true });
var BaseLayer_1 = require("./BaseLayer");
var EventBaseLayer = (function (_super) {
    __extends(EventBaseLayer, _super);
     ...
     */
    EventBaseLayer.generateEvent = function () {
        throw "Implement static Layer.generateEvent()";
    };
    EventBaseLayer.isEvent = function () {
        return true;
    };
    EventBaseLayer.isValid = function () {
...
Object.defineProperty(exports, "__esModule", { value: true });
var EventBaseLayer_1 = require("../bases/EventBaseLayer");
var AudioInfo = {
...
* */
var AudioLayer = (function (_super) {
    __extends(AudioLayer, _super);
    function AudioLayer() {
        return _super.call(this) || this;
    }
    AudioLayer.getInfo = function () {
        return AudioInfo;
    };
    AudioLayer.generateEvent = function (props) {
        var event = {
            name: "play-audio",
            payload: {
...
Object.defineProperty(exports, "__esModule", { value: true });
var DOFBaseLayer_1 = require("../bases/DOFBaseLayer");
...
var BackgroundTextureLayer = (function (_super) {
    __extends(BackgroundTextureLayer, _super);
    function BackgroundTextureLayer() {
        return _super.call(this) || this;
    }
    BackgroundTextureLayer.getInfo = function () {
        return BackgroundTextureInfo;
    };
    BackgroundTextureLayer.generateDofs = function (props) {
        return {
...
var BodyLayer = (function (_super) {
    __extends(BodyLayer, _super);
    function BodyLayer() {
        return _super.call(this) || this;
    }
    BodyLayer.getInfo = function () {
        return BodyInfo;
    };
    BodyLayer.generateDofs = function (props) {
        return {
...
* */
var EventLayer = (function (_super) {
    __extends(EventLayer, _super);
    function EventLayer() {
        return _super.call(this) || this;
    }
    EventLayer.getInfo = function () {
        return EventInfo;
    };
    EventLayer.generateEvent = function (props) {
        var event = {
    ...
    EventLayer.isValid = function (generatedEvent) {
...
var VertexType = function (xRelativeToCenter, yRelativeToCenter) {
    return {
        type: "vector2",
        defaultValue: {
            x: xRelativeToCenter,
...
var EyeAndOverlayLayer = (function (_super) {
    __extends(EyeAndOverlayLayer, _super);
    function EyeAndOverlayLayer() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Object.defineProperty(EyeAndOverlayLayer, "eyeRadiusY", {
        get: function () {
            return eyeRadiusY;
        },
        enumerable: true,
    ...
    Object.defineProperty(EyeAndOverlayLayer, "eyeRadiusX", {
        get: function () {
            return eyeRadiusX;
        },
        enumerable: true,
    ...
    EyeAndOverlayLayer._generateDofs = function (props, nameStem) {
        return _a = {},
            _a[nameStem + "vertexJoint1_t"] = Conversion_1.default.toMetersX(props['Vertex 1'].x) * props.Scale.x,
            _a[nameStem + "vertexJoint1_t_2"] = Conversion_1.default.toMetersY(props['Vertex 1'].y) * props.Scale.y,
            _a[nameStem + "vertexJoint2_t"] = Conversion_1.default.toMetersX(props['Vertex 2'].x) * props.Scale.x,
            _a[nameStem + "vertexJoint2_t_2"] = Conversion_1.default.toMetersY(props['Vertex 2'].y) * props.Scale.y,
            _a[nameStem + "vertexJoint3_t"] = Conversion_1.default.toMetersX(props['Vertex 3'].x) * props.Scale.x,
            _a[nameStem + "vertexJoint3_t_2"] = Conversion_1.default.toMetersY(props['Vertex 3'].y) * props.Scale.y,
            //
            _a[nameStem + "vertexJoint4_t"] = Conversion_1.default.toMetersX(props['Vertex 4'].x) * props.Scale.x,
            _a[nameStem + "vertexJoint4_t_2"] = Conversion_1.default.toMetersY(props['Vertex 4'].y) * props.Scale.y,
            _a[nameStem + "vertexJoint5_t"] = Conversion_1.default.toMetersX(props['Vertex 5'].x) * props.Scale.x,
            _a[nameStem + "vertexJoint5_t_2"] = Conversion_1.default.toMetersY(props['Vertex 5'].y) * props.Scale.y,
            _a[nameStem + "vertexJoint6_t"] = Conversion_1.default.toMetersX(props['Vertex 6'].x) * props.Scale.x,
            _a[nameStem + "vertexJoint6_t_2"] = Conversion_1.default.toMetersY(props['Vertex 6'].y) * props.Scale.y,
            //
            _a[nameStem + "vertexJoint7_t"] = Conversion_1.default.toMetersX(props['Vertex 7'].x) * props.Scale.x,
            _a[nameStem + "vertexJoint7_t_2"] = Conversion_1.default.toMetersY(props['Vertex 7'].y) * props.Scale.y,
            _a[nameStem + "vertexJoint8_t"] = Conversion_1.default.toMetersX(props['Vertex 8'].x) * props.Scale.x,
            _a[nameStem + "vertexJoint8_t_2"] = Conversion_1.default.toMetersY(props['Vertex 8'].y) * props.Scale.y,
            _a[nameStem + "vertexJoint9_t"] = Conversion_1.default.toMetersX(props['Vertex 9'].x) * props.Scale.x,
            _a[nameStem + "vertexJoint9_t_2"] = Conversion_1.default.toMetersY(props['Vertex 9'].y) * props.Scale.y,
            _a;
        var _a;
    };
    EyeAndOverlayLayer.overrideProperties = function (newProps) {
        Object.assign(Info.properties, newProps);
    };
    EyeAndOverlayLayer.extend = function (input) {
        var result = lodash_min_1.merge({}, Info, input);
        return result;
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var EyeAndOverlayLayer_1 = require("./EyeAndOverlayLayer");
var Conversion_1 = require("../utils/Conversion");
var EyeInfo = EyeAndOverlayLayer_1.default.extend({
    layerType: "Eye",
    dofs: {
        eyeSubRootBn_r: true,
        eyeSubRootBn_t: true,
...
var EyeLayer = (function (_super) {
    ...
    EyeLayer.getInfo = function () {
        return EyeInfo;
    };
    Object.defineProperty(EyeLayer, "eyeRadiusX", {
        get: function () {
    ...
    Object.defineProperty(EyeLayer, "eyeRadiusY", {
        get: function () {
    ...
    EyeLayer.generateDofs = function (props) {
        var dofs = EyeAndOverlayLayer_1.default._generateDofs(props, "");
...
var EyeTextureLayer = (function (_super) {
    __extends(EyeTextureLayer, _super);
    function EyeTextureLayer() {
        return _super.call(this) || this;
    }
    EyeTextureLayer.getInfo = function () {
        return EyeTextureInfo;
    };
    EyeTextureLayer.generateDofs = function (props) {
        return {
...
var LEDLayer = (function (_super) {
    __extends(LEDLayer, _super);
    function LEDLayer() {
        return _super.call(this) || this;
    }
    LEDLayer.getInfo = function () {
        return LEDInfo;
    };
    LEDLayer.generateDofs = function (props) {
        return {
...
var EyeAndOverlayLayer_1 = require("./EyeAndOverlayLayer");
var Conversion_1 = require("../utils/Conversion");
var OverlayInfo = EyeAndOverlayLayer_1.default.extend({
    layerType: "Overlay",
    properties: {
        Visible: {
            defaultValue: false
...
var OverlayLayer = (function (_super) {
    ...
    OverlayLayer.getInfo = function () {
        return OverlayInfo;
    };
    OverlayLayer.generateDofs = function (props) {
        var dofs = EyeAndOverlayLayer_1.default._generateDofs(props, "overlay_");
...
var OverlayTextureLayer = (function (_super) {
    __extends(OverlayTextureLayer, _super);
    function OverlayTextureLayer() {
        return _super.call(this) || this;
    }
    OverlayTextureLayer.getInfo = function () {
        return OverlayTextureInfo;
    };
    OverlayTextureLayer.generateDofs = function (props) {
        return {
...
var PixiLayer = (function (_super) {
    ...
    PixiLayer.getInfo = function () {
        return PixiInfo;
    };
    PixiLayer.generateEvent = function (props, layerNum) {
        return {
            name: "play-pixi",
            payload: {
                file: props.Pixi,
    ...
    PixiLayer.isValid = function (generatedEvent) {
...
var ReferenceLayer = (function (_super) {
    __extends(ReferenceLayer, _super);
    function ReferenceLayer() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ReferenceLayer.generateDofs = function () {
        return {};
    };
    ReferenceLayer.getInfo = function () {
...
var operations = {
    lastOneWins: {
        texture: function (accumulated, newValue) {
            return newValue;
        },
        bool: function (accumulated, newValue) {
            return newValue;
        },
        event: function (accumulated, newValue) {
            return newValue;
        },
        audio: function (accumulated, newValue) {
            return newValue;
        }
    },
    add: {
        float: function (accumulated, newValue, defaultValue) {
            return accumulated + (newValue - defaultValue);
        },
        vector2: function (accumulated, newValue, defaultValue) {
            return {
                x: accumulated.x + (newValue.x - defaultValue.x),
                y: accumulated.y + (newValue.y - defaultValue.y)
            };
        },
        rgb: function (accumulated, newValue, defaultValue) {
            return {
    ...
    multiply: {
        float: function (accumulated, newValue) {
            return accumulated * newValue;
        },
        vector2: function (accumulated, newValue) {
            return {
                x: accumulated.x * newValue.x,
                y: accumulated.y * newValue.y
            };
        },
        rgb: function (accumulated, newValue) {
            return {
    ...
    singleton: {
        video: function (accumulated, newValue) {
            return newValue;
        }
    },
    inverse: {
        lastOneWins: {
            texture: function (accumulated) {
                return accumulated;
            },
            bool: function (accumulated) {
                return accumulated;
            }
        },
        singleton: {
            video: function (accumulated) {
                return accumulated;
            }
        },
        add: {
...
var BlendOperations = (function () {
    ...
    BlendOperations.inverse = function (operation, type) {
    ...
    BlendOperations.normal = function (operation, type) {
        // Operation none for any type is the same as lastOneWins for textures
        if (operation === 'none') {
...
var Channels = (function () {
    ...
    Channels.radiansToDegrees = function (radians) {
        return radians / Math.PI * 180;
    };
    Channels.degreesToRadians = function (degree) {
        return degree / 180 * Math.PI;
    };
    Channels.framesToSeconds = function (frame, frameRate) {
        return frame / frameRate;
    };
    Channels.secondsToFrames = function (timeInSeconds, totalTimeInSeconds, totalFrames) {
        return Math.round(timeInSeconds / totalTimeInSeconds * (totalFrames));
    };
    Channels.toTextureURL = function (jiboConfig, displayValue) {
        return this.baseTextureURL + this.getPaddedValueString(displayValue) + ".png";
    };
    Channels.toBGTextureURL = function (jiboConfig, displayValue) {
...
var Conversion = (function () {
    ...
    Conversion.toMetersX = function (xInPixels) {
        return (xInPixels) / WIDTH_PIXELS * WIDTH_METERS;
    };
    Conversion.toMetersY = function (yInPixels) {
        return (yInPixels) / HEIGHT_PIXELS * HEIGHT_METERS * -1;
    };
    Conversion.toPixelsX = function (xInMeters) {
        return xInMeters / WIDTH_METERS * WIDTH_PIXELS;
    };
    Conversion.toPixelsY = function (yInMeters) {
...
var JiboKeyframeInfo_1 = require("../JiboKeyframeInfo");
 ...
 */
var KeyframesCompositer = (function () {
    /**
     * Constructor
     ...
     */
    function KeyframesCompositer(basepath, animdbPath, fileDir, assetPack) {
    ...
    KeyframesCompositer.prototype.setNoWarn = function () {
        this.noWarn = true;
    };
    /**
     ...
     */
    KeyframesCompositer.prototype.getCompositedContentLayers = function (frames) {
     ...
     * @returns {Array}
     */
    KeyframesCompositer.prototype.getCompositedReferenceLayers = function (frames) {
        return this.getCompositedlayers(frames).referenceLayers;
    };
    KeyframesCompositer.prototype.getCompositedlayers = function (frames) {
        var inputString = JSON.stringify(frames);
        if (!(inputString in this.cache)) {
            ...
            var cacheEntries = Object.keys(this.cache).length;
     ...
     * @returns {Keyframes} composited keyframes object.
     */
    KeyframesCompositer.prototype.compositeKeysfile = function (url) {
        var frames = Runtime_1.default.load(url, JiboKeyframeInfo_1.default);
     ...
     */
    KeyframesCompositer.prototype.getReferencedUrl = function (keyframe, refBase) {
        var url;
        var assetPack;
        if (keyframe.value.ReferenceMode.value === 'name') {
            var name_1 = keyframe.value.KeysFileReference.name;
            var anim = this.animDB.getAnimByName(name_1);
            if (!anim) {
                this.warn("animdb name lookup failed on " + name_1);
            }
            else {
     ...
     */
    KeyframesCompositer.prototype.processReferencesInKeyframes = function (frames, refBase) {
        var contentLayers = this.dereferenceKeyframes(frames, refBase);
        this.removeHoldSafesInReferences(contentLayers);
        var referenceLayers = this.removeReferenceLayers(contentLayers);
        return { contentLayers: contentLayers, referenceLayers: referenceLayers };
    };
    /**
     ...
     * @returns {Keyframes} composited keyframes object.
     */
    KeyframesCompositer.prototype.dereferenceKeyframes = function (frames, refBase) {
        var fileRefs = this.getKeyFileReferences(frames, refBase);
     ...
     * @returns {Keyframes} composited keyframes object.
     */
    KeyframesCompositer.prototype.nestedLoad = function (url, assetPack, prefix) {
        var frames = Runtime_1.default.load(url, JiboKeyframeInfo_1.default);
        var dir = path.dirname(url);
     ...
     */
    KeyframesCompositer.prototype.resolveAssetRefs = function (frames, assetPack) {
        if (assetPack) {
     ...
     */
    KeyframesCompositer.prototype.getKeyFileReferences = function (frames, refBase) {
        var fileRefs = [];
     ...
     * @returns {string}
     */
    KeyframesCompositer.prototype.zeroPad = function (num, size) {
     ...
     */
    KeyframesCompositer.prototype.removeHoldSafesInReferences = function (frames) {
        for (var _i = 0, _a = frames.layers; _i < _a.length; _i++) {
            var layer = _a[_i];
     ...
     */
    KeyframesCompositer.prototype.removeReferenceLayers = function (frames) {
        var referenceLayers = [];
        for (var i = 0; i < frames.layers.length; i++) {
            var layer = frames.layers[i];
            if (layer.type === 'Reference') {
     ...
     */
    KeyframesCompositer.prototype.timeshift = function (frames, validFrom, validUpto, holdAfter) {
        for (var _i = 0, _a = frames.layers; _i < _a.length; _i++) {
            var layer = _a[_i];
     ...
     */
    KeyframesCompositer.prototype.composite = function (layerNumber, existingFrames, toBeInsertedFrames) {
        for (var i = toBeInsertedFrames.layers.length - 1; i >= 0; i--) {
     ...
     * @param {string} prefix
     */
    KeyframesCompositer.prototype.fixLayerIds = function (frames, prefix) {
        var i = 0;
        for (var _i = 0, _a = frames.layers; _i < _a.length; _i++) {
            var layer = _a[_i];
     ...
     * @returns {boolean}
     */
    KeyframesCompositer.prototype.isReferencedLayer = function (layer) {
        return layer.id.indexOf('-') >= 0;
    };
    /**
     ...
     * @param prefix
     */
    KeyframesCompositer.prototype.hasCircularReference = function (frames, prefix) {
        for (var _i = 0, _a = frames.layers; _i < _a.length; _i++) {
            var layer = _a[_i];
     ...
     * @returns {string}
     */
    KeyframesCompositer.prototype.convertToAssetReference = function (assetPack, filepath) {
    ...
    KeyframesCompositer.prototype.watchForChanges = function (url) {
        var _this = this;
        if (url in this.watchedFiles) {
            return;
        }
        this.watchedFiles[url] = true;
        fs.watch(url, function (event, filename) {
            _this.cache = {};
            console.log("File " + filename + " had event: " + event + " ");
        });
    };
    KeyframesCompositer.prototype.warn = function (error) {
    ...
    return KeyframesCompositer;
}());
exports.default = KeyframesCompositer;
/**
 * Poor man's animDB -- only supports name lookup.
 */
var miniAnimdb = (function () {
    function miniAnimdb(basepath, animdbPath) {
        if (!animdbPath) {
        ...
        if (!fs.existsSync(animdbPath)) {
            ...
            for (var key in this.animdb) {
                this.animdb[key.toLowerCase()] = this.animdb[key];
            }
        }
    }
    miniAnimdb.prototype.getAnimByName = function (name) {
...
var KeysUtils = (function () {
     ...
     * @param cb
     */
    KeysUtils.keysToAnimObjectAsync = function (keysPath, cb) {
        fs.readFile(keysPath, 'utf8', function (err, data) {
            if (err) {
                ...
                var baseName = path.basename(keysPath);
     ...
     * @returns {*}
     */
    KeysUtils.keysToAnimObject = function (keysPath) {
        var keysData;
        try {
            // Load .keys file
     ...
     * @param animPath
     */
    KeysUtils.keysToAnim = function (keysPath, animPath) {
     ...
     * @param cb
     */
    KeysUtils.getCachedAnimForKeysAsync = function (keysFile, cb) {
        var animFile = KeysUtils.keysPathToAnimPath(keysFile);
        if (fs.existsSync(animFile) && fs.statSync(animFile).mtime >= fs.statSync(keysFile).mtime) {
            fs.readFile(animFile, 'utf8', function (err, data) {
                if (err) {
                    return cb(err);
                }
                var animData = JSON.parse(data);
                cb(null, animData);
            });
        }
        else {
     ...
     * @param keysFile
     */
    KeysUtils.getCachedAnimForKeys = function (keysFile) {
        var animFile = KeysUtils.keysPathToAnimPath(keysFile);
        if (fs.existsSync(animFile) && fs.statSync(animFile).mtime >= fs.statSync(keysFile).mtime) {
            var data = fs.readFileSync(animFile, 'utf8');
            var animData = JSON.parse(data);
            return animData;
        }
    };
     ...
     * @param cb
     */
    KeysUtils.keysObjToAnimObjectAsync = function (keysData, filename, options, cb) {
        JiboKeyframeInfo_1.default.onLoad(keysData);
        KeysUtils.getCachedAnimForKeysAsync(filename, function (err, cachedData) {
            if (err) {
                return cb(err);
            }
            if (!cachedData) {
     ...
     * @returns {null}
     */
    KeysUtils.keysObjToAnimObject = function (keysData, filename) {
        JiboKeyframeInfo_1.default.onLoad(keysData);
        var cachedData = filename ? KeysUtils.getCachedAnimForKeys(filename) : null;
        if (!cachedData) {
            cachedData = KeysUtils.computeAnimObject(keysData, filename);
        }
        return cachedData;
    };
    KeysUtils.keysPathToAnimPath = function (keysfile) {
        return keysfile.replace(/\.keys$/, '.anim');
    };
    KeysUtils.getCacheFileNameIfAvailable = function (keysfile, cacheExt, cb) {
        var cacheFile = keysfile.replace(/\.keys$/, cacheExt);
        fs.stat(cacheFile, function (err, stats) {
            if (err) {
                return cb(null, null);
            }
            var cacheMtime = stats.mtime;
            fs.stat(keysfile, function (err, stats) {
                if (err) {
                    return cb(err);
                }
                var keysMtime = stats.mtime;
                cb(null, (cacheMtime >= keysMtime) ? cacheFile : null);
            });
        });
    };
    KeysUtils.getAnimFilePath = function (keysfile, cb) {
        KeysUtils.getCacheFileNameIfAvailable(keysfile, '.anim', cb);
    };
    KeysUtils.getAssetsFilePath = function (keysfile, cb) {
     ...
     */
    KeysUtils.computeAnimObject = function (keysData, filename) {
        var animData = {
            header: {
                fileType: "Animation",
        ...
        for (var frame = 0; frame < keysData.duration; frame++) {
            var timeInSeconds = Channels_1.default.framesToSeconds(frame, keysData.framerate);
            var dofs = Runtime_1.default.evaluateAllDOFLayers(keysData, JiboKeyframeInfo_1.default, timeInSeconds);
            var events = Runtime_1.default.evaluateAllEventLayers(keysData, JiboKeyframeInfo_1.default, timeInSeconds);
            for (var dofName in dofs) {
                if (typeof animChannels[dofName] === "undefined") {
                    ...
                    var values = animChannels[dofName].values;
                    var times = animChannels[dofName].times;
                    var value = dofs[dofName];
                    // *** DOF KOMPRESSOR ***
                    ...
                    if (length_1 >= 2 && "" + values[length_1 - 1] === svalue && "" + values[length_1 - 2] === svalue) {
                        times.pop();
                        values.pop();
                    }
...
},{"../JiboKeyframeInfo":1,"../Runtime":2,"./Channels":19,"fs":undefined,"path":undefined}],25:[function(require,module,exports){
"use strict";
/**
...
var Search = (function () {
    ...
    Search.keyframeSearch = function (keyframes, currentTime) {
        var lo = 0, hi = keyframes.length - 2, mid /*,
        steps = 0*/;
        while (lo <= hi) {
    ...
    Search.keyframeSearchAbsolute = function (keyframes, keyframeTime) {
 ...
 */
var lodash_min_1 = require("lodash/lodash.min");
var easesFunctions = require("eases");
/**
 ...
 */
var easing = lodash_min_1.clone(easesFunctions);
/**
 * "snap" always returns a weight fully weighted to the last keyframe
 */
easing.snap = function () { return 0; };
var Tweening = (function () {
     ...
     */
    Tweening.getEasingFunc = function (easingFuncOrString) {
     ...
     */
    Tweening.float = function (start, end, time, easing) {
     ...
     * @param {function|string} easing function or name of a built-in easing function that calculates the blending weights
     */
    Tweening.vector2 = function (start, end, time, easing) {
        var f = Tweening.getEasingFunc(easing)(time);
        return {
     ...
     * @param {function|string} easing function or name of a built-in easing function that calculates the blending weights
     */
    Tweening.rgb = function (start, end, time, easing) {
        var f = Tweening.getEasingFunc(easing)(time);
        return {
     ...
     * @param {function|string} easing function or name of a built-in easing function that calculates the blending weights
     */
    Tweening.color = function (start, end, time /*, easing*/) {
        var f = Tweening.getEasingFunc("linear")(time);
        return start * (1 - f) + end * f;
    };
    Tweening.texture = function (start /*, end, time, easing*/) {
        return start;
    };
    Tweening.video = function (start /*, end, time, easing*/) {
        return start;
    };
    Tweening.bool = function (start) {
        return start;
    };
    Tweening.enum = function (start /*, end, time, easing*/) {
        return start;
    };
    Tweening.pixi = function (start) {
        return start;
    };
    Tweening.keysref = function (start) {
        return start;
    };
    return Tweening;
}());
 ...
 * keyframes entry point.
 */
var KeysUtils_1 = require("./utils/KeysUtils");
...
var Tweening_1 = require("./utils/Tweening");
var JiboKeyframeInfo_1 = require("./JiboKeyframeInfo");
var KeyframesCompositer_1 = require("./utils/KeyframesCompositer");
var Runtime_1 = require("./Runtime");
module.exports = {
