...
class AnimationInstance extends jibo_client_framework_1.ClientRemoteObject {
    constructor(client, instanceId, id, dofs) {
    ...
    cancel() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.resolved || this.canceled) {
                if (this.canceled) {
                    log.info("Someone tried to cancel ResolveHandle twice!");
                ...
                this.canceled = true;
                yield this.sendMessage('cancel', [], true);
            }
        });
    }
    onPromise(result) {
...
exports.default = new Log('Jibo.Expression');
