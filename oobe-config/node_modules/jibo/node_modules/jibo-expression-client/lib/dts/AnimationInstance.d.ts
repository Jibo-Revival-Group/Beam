 ...
 * @prop REJECTED
 */
export declare type AnimationState = 'INVALID' | 'PLAYING' | 'STOPPED' | 'STOPPING' | 'CANCELLED' | 'PAUSED' | 'RESUMED' | 'STARTED' | 'REJECTED';
export declare namespace AnimationState {
    const INVALID: AnimationState;
    const PLAYING: AnimationState;
    const STOPPED: AnimationState;
    const STOPPING: AnimationState;
    const CANCELLED: AnimationState;
    const PAUSED: AnimationState;
    const RESUMED: AnimationState;
    const STARTED: AnimationState;
    const REJECTED: AnimationState;
}
/**
...
export declare class AnimationInstance extends ClientRemoteObject {
     ...
     */
    constructor(client: RemoteClient, instanceId: number, id: string, dofs: DOFSet);
    /**
