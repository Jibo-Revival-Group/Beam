...
export declare class FileUtils {
     ...
     */
    static findAllFiles(baseDir: string, selector: (string) => boolean): Promise<string[]>;
    static _findAllFiles(baseDir: string, selector: (string) => boolean, out: string[]): Promise<void>;
    /**
