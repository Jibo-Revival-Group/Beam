...
export declare class StateMachine extends events.EventEmitter {
    ...
    private _traceIndex;
    private _trace;
    private _currentStateExitPromise;
    constructor();
    /**
