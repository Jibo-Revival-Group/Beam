...
const Types_1 = require("../common/Types");
const log_1 = require("../log");
const log = log_1.default.createChild('Appraisal');
...
},{"../common/Types":13,"../log":25,"jibo-typed-events":undefined}],4:[function(require,module,exports){
"use strict";
function __export(m) {
    for (var p in m) if (!exports.hasOwnProperty(p)) exports[p] = m[p];
}
...
class IdentityRule extends AppraisalRule_1.AppraisalRule {
    ...
    appraiseData(input) {
        switch (input) {
            case Types_1.IdentityEvents.PRESENCE_STARTED:
                return new Types_1.EmotionPoint(Types_1.RuleImpactValues.PRESENCE_STARTED_VALENCE, Types_1.RuleImpactValues.PRESENCE_STARTED_CONFIDENCE);
...
(function (EmotionName) {
    EmotionName.PLEASED = 'PLEASED';
    EmotionName.SAD = 'SAD';
    EmotionName.NEUTRAL = 'NEUTRAL';
    EmotionName.CONFIDENT = 'CONFIDENT';
    EmotionName.UNCERTAIN = 'UNCERTAIN';
    EmotionName.PESSIMISTIC = 'PESSIMISTIC';
    EmotionName.FRUSTRATED = 'FRUSTRATED';
    EmotionName.HOPEFUL = 'HOPEFUL';
    EmotionName.JOYFUL = 'JOYFUL';
    EmotionName.BASELINE = 'BASELINE';
...
exports.DEFAULT_EMOTIONS.set(Types_1.EmotionName.UNCERTAIN, { valence: 0, confidence: -1 });
exports.DEFAULT_EMOTIONS.set(Types_1.EmotionName.PESSIMISTIC, { valence: -1, confidence: 1 });
...
exports.EMOTION_TO_ANIM_CATEGORY.set(Types_1.EmotionName.HOPEFUL, 'curious');
...
},{"../common/Types":13,"../emotion/EmotionDefinitions":17,"../log":25}],22:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const Types_1 = require("../common/Types");
...
const log_1 = require("../log");
const log = log_1.default.createChild('Expression');
class ExpressionSystem {
    ...
    express(emotionTrace) {
        ...
        if (emotionTrace.appraisalRule && emotionTrace.appraisalRule.name === Types_1.RuleNames.TouchRule) {
            ...
            this.expressAnimation(ExpressionMaps_1.TouchExpressions.get(touchData.type));
        }
    ...
    expressAnimation(options) {
        this.parent.jibo.action.addPlayAnimationGoal(options);
    }
}
exports.ExpressionSystem = ExpressionSystem;

},{"../common/Types":13,"../log":25,"./ExpressionMaps":22}],24:[function(require,module,exports){
"use strict";
function __export(m) {
    for (var p in m) if (!exports.hasOwnProperty(p)) exports[p] = m[p];
}
...
exports.default = new Log('Jibo.Emotion');
...
},{"../../common/Types":13,"../../log":25,"./Sensor":34}],36:[function(require,module,exports){
"use strict";
function __export(m) {
    for (var p in m) if (!exports.hasOwnProperty(p)) exports[p] = m[p];
}
