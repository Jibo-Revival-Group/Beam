...
declare class Account extends Service {
  ...
  /**
   *  Generates temporary access token to be used by robot. 
   */
   ...
   */
  getAccountByAccessToken(params: Account.Types.TokenContainer, callback?: (err: AWSError, data: Account.Types.Account) => void): Request<Account.Types.Account, AWSError>;
  /**
   *  Retrieves account credentials by temporary access token. 
   */
  getAccountByAccessToken(callback?: (err: AWSError, data: Account.Types.Account) => void): Request<Account.Types.Account, AWSError>;
  /**
