...
declare namespace rendering {
    ...
    export namespace animation {
        ...
        export class KeysAnimation extends EventEmitter {
            ...
            public playSync(instance:animate.MovieClip, event?:string|Function, callback?:Function): void;
            public destroy():void;
    ...
    export namespace gui {
        ...
        export abstract class Component extends EventEmitter {
            ...
            public destroy():void;
            public open(callback:Function, transitionType?:string, duration?:number):void;
            public close(callback:Function, transitionType?:string, duration?:number):void;
            ...
            public addSubcomponent(subcomponent:subcomponents.Subcomponent):subcomponents.Subcomponent;
            public getSubcomponent(type:string):subcomponents.Subcomponent;
        }
        export abstract class ComponentGroup extends Component {
            ...
            public getIndexOfComponent(component:Component):number;
            public removeComponent(componentDeterminer: Component|number|string):Component;
            ...
            public destroy();
            public findComponent(testFunction:(component:Component, against?:any) => boolean, against?:any):Component
            protected openChildren(callback:Function, transitionType?:string, duration?:number):void;
            protected closeChildren(callback:Function, transitionType?:string, duration?:number):void;
        ...
        export namespace components {
            export abstract class Element extends Component {
                ...
                public ready():void;
                public open(callback:Function, transitionType?:string, duration?:number, tweenType?:string):void;
                public close(callback:Function, transitionType?:string, duration?:number, tweenType?:string):void;
                public destroy():void;
                public lockInput(flag:boolean):void;
            }
            ...
            export class Clip extends Element {
                ...
                public movieClip:animate.MovieClip;
            ...
            export class Label extends Element {
                ...
                public applyPosition():void;
                public centerPivot():void
                public open(callback?:Function, transitionType?:string, duration?:number, tweenType?:string):void;
                public close(callback?:Function, transitionType?:string, duration?:number, tweenType?:string):void;
            }
            type ElementTransition = (element:Element, done?:Function) => any;
            export class List extends ComponentGroup {
                ...
                public static REMOVE_ELEMENT:string;
                ...
                public open(callback:Function, transitionType?:string, duration?:number):void;
                public close(callback:Function, transitionType?:string, duration?:number):void;
                public openVertical(callback:Function, transitionType?:string, duration?:number, tweenType?:string):void;
                public closeVertical(callback:Function, transitionType?:string, duration?:number, tweenType?:string):void;
                public openFromEye(callback:Function, duration?:number):void;
                public closeToEye(callback:Function, duration?:number):void;
                public destroy():void;
                public removeComponent(componentDeterminer: Component|number|string, done?:Function, transition?:ElementTransition):Component;
                public lockInput(flag:boolean):void;
                ...
                protected setTargetsByPage(pageIndex:number):void;
        ...
        export namespace views {
            ...
            interface ViewOptions {
                ...
                type?:string;
                assets?:any;
                category?:'gui'|'display'|'eye';
                soundSet?:string;
                ignoreSwipeDown?:boolean;
                transitionStageOnly?:boolean;
                pause?:boolean|PauseOptions;
                pauseParent?:boolean;
                pauseOptions?:PauseOptions;
            }
            export enum STACK_DIRECTION {
                ADD = 1,
                REMOVE = 2,
                SWAP = 3
            }
            export type TransitionHandler = (done:Function, view?:views.View) => any;
            export class View extends ComponentGroup {
                ...
                public transitionHandler:TransitionHandler|string;
                ...
                public actionHandler(action:actions.ActionData, fromComponent?:Component):void;
                public assignConfig(viewConfig?:ViewOptions):any;
                ...
                public setupScreenClick():void;
                public addTransition(viewType:string, openFrom:boolean, myTransition?:TransitionHandler|string, theirTransition?:TransitionHandler|string, stackDirection?:STACK_DIRECTION):void;
                public applyTransitions(view:View|string, openFrom?:boolean):void
            ...
            export class MenuView extends View {
                ...
                public assignConfig(viewConfig?:ViewOptions):any
                public updateConfig(configObject?:any):any;
                public addEyeTransitions():void;
                public openFromEye(callback:Function):void;
                public closeToEye(callback:Function):void
                protected createListComponents(list:components.List):void;
                protected loaded():void;
                protected positionComponents(overrideTitleHeight?:number):void;
                protected updateButtonLabels(playTransition?:boolean, duration?:number):void
            }
            export class EyeView extends View {
                public static DEFAULT_TYPE:string;
                public open(callback?:Function, transitionType?:string):void;
                public close(callback?:Function, transitionType?:string):void;
            }
        ...
        export class ViewManager {
            ...
            public static TRANS_EYE:string;
            ...
            public STACK_ADD:views.STACK_DIRECTION.ADD;
            public STACK_REMOVE:views.STACK_DIRECTION.REMOVE;
            public STACK_SWAP:views.STACK_DIRECTION.SWAP;
            ...
            public addView(viewDeterminer:views.View|string|any, onAdded?:ViewCallback, openTransition?:string, closeTransition?:string, onFailure?:Function):void;
