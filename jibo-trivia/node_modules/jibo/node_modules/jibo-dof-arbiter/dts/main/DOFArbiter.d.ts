...
declare class DOFArbiter {
     ...
     * @private
     */
    private notifyListenersOfDOFLoss(dofLosses);
    /**
     *
     ...
     * @private
     */
    private notifyListenerOfDOFGain(ownerGaining, dofsBeingGained);
    /**
     ...
     * @private
     */
    private markInUseByInstance(requester, instance, dofsToUse);
    /**
     ...
     * @private
     */
    private markAsUsedByTransient(requester, dofsToUse);
    /**
     ...
     * @private
     */
    private globalAnimationEventHandler(eventName, instance, payload);
    /**
     *
     ...
     * @private
     */
    private globalLookatEventHandler(eventName, instance, payload);
    /**
     *
     ...
     * @private
     */
    private globalEventHandler(eventName, instance, payload);
}
