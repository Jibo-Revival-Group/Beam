...
},{"./ModalityHandler":8,"./SensoryRecord":11,"./TrackedSensory":14,"animation-utilities":undefined}],2:[function(require,module,exports){
"use strict";
...
},{"./SimpleAnimGenerator":13,"animation-utilities":undefined}],3:[function(require,module,exports){
"use strict";
var AnimationUtilities = require("animation-utilities");
var slog = AnimationUtilities.slog;
var eventQueue = [];
...
AttentionEyeRecessor.prototype.shouldRecess = function () {
    return (this._lastTarget === null || this._lastTarget.distanceTo(this._currentTarget) > this._recessionThreshold);
};
...
AttentionEyeRecessor.prototype.lookStarted = function (eventName, instance, payload) {
    if (this.shouldRecess()) {
        this._dofArbiter.playAnimation(this._recessedBuilder, this._emChannel);
...
},{"./SimpleAnimGenerator":13}],5:[function(require,module,exports){
"use strict";
...
AttentionRuleCommandLook.prototype.resolveCompletion = function (status) {
    if (this._attendHandle != null) {
        ...
        slog(channel, "AttentionRuleCommandLook:Resolved Twice!");
    }
};
...
AttentionRuleCommandLook.prototype.reset = function () {
    ...
    if (this._target !== null) {
        slog(channel, "AttentionRuleCommandLook reset after command but before activating!  Sending Cancelled");
...
AttentionRuleCommandLook.prototype.notifyDidFire = function () {
    ...
    this._target = null;
    slog(channel, "ATTENTION: DID command look!");
};
...
AttentionRuleBodySound.prototype.getTarget = function (time, tracks, recentAttentionHistory) {
    ...
    if (tracks.mostWeightyAudio !== null && tracks.mostWeightyAudio.weight > loudSoundBodyMoveWeightThreshold) {
        slog(channel, "ATTENTION: Doing body sound");
...
AttentionRuleEyeReturn.prototype.getTarget = function (time, tracks, recentAttentionHistory) {
    if (recentAttentionHistory.lastBodyTarget !== null) {
        if (recentAttentionHistory.lastEyeTarget !== null &&
            (this._eyeBodyDeltaPosThreshold === null || recentAttentionHistory.lastEyeTarget.distanceTo(recentAttentionHistory.lastBodyTarget) < this._eyeBodyDeltaPosThreshold) &&
...
AttentionRuleBlinkOccasionally.prototype.update = function (time, tracks, rulesState, recentAttentionHistory) {
    ...
    if (!enabled) {
        ...
        if (time.subtract(this.activeIdleStart) > currentRequiredIdle) {
            this.blinker.blink();
            slog(channel, "ATTENTION: Doing Occasional Blink (" + this.currentInterval + ")");
            this.currentRequiredIdle = null;
            this.firedAt = time;
            if (this.selfResetsIdle) {
                this.activeIdleStart = null;
...
var install = function (animate, glService, lps, attentionManager, dofArbiter, doRemoteVis, configData) {
    ...
    if (doRemoteVis) {
        ...
        remoteVisualizerConnection = new RemoteVisualizerConnection(animate, attentionManager, sensoryLogController, dofArbiter, EMChannel);
    }
    ...
    var expressionListener = {
        dofsLost: function (ownerWhoLostDOFs, dofsLost) {
            attentionManager.handleLossOfActiveDOFs(dofsLost);
        },
    ...
    dofArbiter.addListener(EMChannel, expressionListener);
};
var AttentionManager = function (jibo, doRemoteVis, configData) {
    ...
    this._eyeRecessor = new AttentionEyeRecessor(this._animate, this._dofArbiter, EMChannel);
    this._needToFireOnNewWake = false;
    this._faceAwaiters = [];
    if (this._animate !== null) {
        var attentionDebugStateVisualizer = new AttentionDebugStateVisualizer(this._animate, this._dofArbiter, EMChannel);
    ...
    var lookConfigDefaultEyeOnly = new LookConfig("DefaultEye", robotInfo, true);
    var lookConfigDefault = new LookConfig("Default", robotInfo, false);
    var lookConfigSlow = new LookConfigSlow("Slow", robotInfo, false);
    var lookConfigSlowEyeOnly = new LookConfigSlow("SlowEye", robotInfo, true);
    var lookConfigShort = new LookConfigShort("Short", robotInfo);
    var lookConfigDisengage = new LookConfigDisengage("Disengage", robotInfo);
    var lookConfigUncommitted = new LookConfigUncommitted("Uncommitted", robotInfo);
    var lookConfigVisionFace = new LookConfigEyeVision("EyeVision:Face", robotInfo, "FACE", false, true);
    var lookConfigVisionMotion = new LookConfigEyeVision("EyeVision:Motion", robotInfo, "MOTION", false, true);
    var lookConfigVisionMotionEyeOnly = new LookConfigEyeVision("EyeVision:MotionEye", robotInfo, "MOTION", true, false);
    var requiredDOFsForBlink = animate.dofs.EYE.getDOFs();
    var blinker = {
        blink: function (interrupt) {
            if (dofArbiter.getAvailable(EMChannel, requiredDOFsForBlink, null).length === requiredDOFsForBlink.length) {
    ...
    this._rules = {
        ...
        ENGAGED: [
            new AttentionRuleHeyJibo("Engaged Hey Jibo", 0.5, 0, lookConfigDefault),
            new AttentionRuleBodySound("Engaged Body Sound", 0.5, 2, 2.63, lookConfigDefault),
            new AttentionRuleEyeMotion("Engaged Eye Recent Motion", 0.0, 0.7, 1.0, true, 1, 4, lookConfigVisionMotionEyeOnly),
            new AttentionRuleEyeFace("Engaged Face", 0.0, 0.7, 1.0, lookConfigVisionFace),
            new AttentionRuleEyeMotion("Engaged Motion", 0.0, 0.7, 1.0, false, 0, 0, lookConfigVisionMotion),
        ...
        COMMAND: [
            new AttentionRuleCommandLook("Command Look", 0.5, 0, lookConfigDefault)
        ]
    };
...
AttentionManager.prototype.awaitFace = function (timeout, maxAngle, fullSearchTime) {
    ...
    var awaiter = new FaceAwaiter(currentTime, timeout, maxAngle, fullSearchTime, this._animate, this._lpsConnection);
...
AttentionManager.prototype.handleLossOfActiveDOFs = function (dofsLost) {
...
AttentionManager.prototype.setTarget = function (position, isHeyJibo, lookatConfig, lastTarget, lookSucceededListener, lookInterruptedListener, rule) {
    var newLook = this._currentInstanceIsMissingDOFs ||
        lookatConfig !== this._lastLookatConfig ||
    ...
    if (this._lookatInstance === null || newLook) {
        var availableDOFs = this._dofArbiter.getAvailable(EMChannel, dofs, null);
        if (availableDOFs.length === dofs.length) {
            ...
            this._lookatInstance = this._dofArbiter.startLookat(lookatBuilder, EMChannel, position, null);
            if (this._lookatInstance !== null) {
                this._lastLookatConfig = lookatConfig;
                ...
                if (body && !torsoEnabled && this._defaultBuilder !== null) {
                    ...
                    this._dofArbiter.playAnimation(this._defaultBuilder, EMChannel, null);
                }
            }
            else {
            ...
            slog(channel, "Attention Manager Not Trying to do lookat, we have no dofs!!");
        }
    }
    else {
        if (this._eyeRecessor != null && this._lastLookatConfig !== null && this._lastLookatConfig.doRecession) {
...
var assembleData = function (sensoryStore, currentTime, timestampOfLastUsedHeyJibo) {
    var i;
    ...
    return { newHeyJibo: validNewHeyJibo, heyJibo: mostRecentHeyJibo, mostWeightyAudio: mostWeighty, trackedFaces: trackedFaces, trackedMotions: trackedMotions };
};
AttentionManager.prototype.update = function () {
    var i;
    var overrideMode = Bakery.getFloat("Override Mode", -1, 5, -1, "AttentionDebug");
    if (overrideMode >= 0) {
    ...
    var tracks = assembleData(this._sensoryStore, currentTime, this._ignoreHeyJibosAtOrBefore);
...
},{"./AttentionDebugStateVisualizer":2,"./AttentionEventDispatcher":3,"./AttentionEyeRecessor":4,"./DataConverter":7,"./MotorMotionMonitor":10,"./SensoryRecord":11,"./SensoryStore":12,"./actions/AttendHandle":16,"./actions/FaceAwaiter":18,"./actions/ResultStatus":19,"./actions/TridentSearchIterator":21,"./log/SensoryLogController":23,"./lookconfig/LookConfig":26,"./lookconfig/LookConfigDisengage":27,"./lookconfig/LookConfigEyeVision":28,"./lookconfig/LookConfigShort":29,"./lookconfig/LookConfigSlow":30,"./lookconfig/LookConfigUncommitted":31,"./remote/RemoteVisualizerConnection":41,"animation-utilities":undefined,"find-root":undefined}],6:[function(require,module,exports){
"use strict";
var AnimationUtilities = require("animation-utilities");
var Clock = AnimationUtilities.Clock;
var Bakery = AnimationUtilities.ui.Bakery;
...
AudioModalityHandler.prototype.accept = function (sensoryRecord) {
    var matching = null;
    var minHeight = Bakery.getFloat("Localized-Audio Height Floor", -1, 1, 0.7, "SensoryFilters");
    if (sensoryRecord.position.z < minHeight) {
        sensoryRecord.position.z = minHeight;
    }
...
},{"./ModalityHandler":8,"./SensoryRecord":11,"./TrackedSensory":14,"animation-utilities":undefined}],7:[function(require,module,exports){
"use strict";
var SensoryRecord = require("./SensoryRecord");
var AnimationUtilities = require("animation-utilities");
var THREE = AnimationUtilities.THREE;
...
},{"./SensoryRecord":11,"animation-utilities":undefined}],8:[function(require,module,exports){
"use strict";
var AnimationUtilities = require("animation-utilities");
var Clock = AnimationUtilities.Clock;
...
},{"animation-utilities":undefined}],9:[function(require,module,exports){
"use strict";
var AnimationUtilities = require("animation-utilities");
var Time = AnimationUtilities.Time;
var Bakery = AnimationUtilities.ui.Bakery;
...
},{"./ModalityHandler":8,"./SensoryRecord":11,"./TrackedSensory":14,"animation-utilities":undefined}],10:[function(require,module,exports){
"use strict";
var AnimationUtilities = require("animation-utilities");
var Clock = AnimationUtilities.Clock;
...
},{"animation-utilities":undefined}],11:[function(require,module,exports){
"use strict";
var AnimationUtilities = require("animation-utilities");
var THREE = AnimationUtilities.THREE;
var Time = AnimationUtilities.Time;
...
},{"./ALWakeModalityHandler":1,"./AudioModalityHandler":6,"./MotionModalityHandler":9,"./SensoryRecord":11,"./VisionModalityHandler":15}],13:[function(require,module,exports){
"use strict";
...
},{"animation-utilities":undefined}],15:[function(require,module,exports){
"use strict";
var AnimationUtilities = require("animation-utilities");
var Time = AnimationUtilities.Time;
var Bakery = AnimationUtilities.ui.Bakery;
...
},{"./ModalityHandler":8,"./SensoryRecord":11,"./TrackedSensory":14,"animation-utilities":undefined}],16:[function(require,module,exports){
"use strict";
...
var AnimationUtilities = require("animation-utilities");
var slog = AnimationUtilities.slog;
var FaceAwaiter = function (currentTime, timeout, maxAngle, fullSearchTime, animate, lpsConnection) {
    var _this = this;
    ...
    this._timeoutImmediatelyIfDemandFindsNoone = true;
    this._haveDemandedFaces = false;
...
FaceAwaiter.prototype.update = function (currentTime, perceptionState) {
    ...
    if (winningFace !== null) {
        this.resolveCompletion(ResultStatus.SUCCEEDED, null, winningFace.position.clone(), winningFaceAngle);
        return false;
    }
    ...
    if (this._timeout > 0.5 && this._haveDemandedFaces === false && this._lpsConnection !== null) {
        this._haveDemandedFaces = true;
...
},{"./AwaitFaceHandle":17,"./ResultStatus":19,"animation-utilities":undefined}],19:[function(require,module,exports){
"use strict";
var ResultStatus = {
    SUCCEEDED: "SUCCEEDED",
    TIMEOUT: "TIMEOUT",
...
},{"./SearchIterator":20,"animation-utilities":undefined}],22:[function(require,module,exports){
"use strict";
var AnimationUtilities = require("animation-utilities");
var AttentionLog = {};
...
},{"animation-utilities":undefined}],23:[function(require,module,exports){
"use strict";
...
},{"./SensoryLogDataSource":24,"./SensoryLogger":25}],24:[function(require,module,exports){
"use strict";
...
},{"../SensoryRecord":11,"./AttentionLog":22,"animation-utilities":undefined}],25:[function(require,module,exports){
"use strict";
var AttentionLog = require("./AttentionLog");
...
},{"./AttentionLog":22}],26:[function(require,module,exports){
"use strict";
var AnimationUtilities = require("animation-utilities");
var Bakery = AnimationUtilities.ui.Bakery;
...
var LookConfig = function (name, robotInfo, eyeOnly) {
    this.name = name;
...
},{"animation-utilities":undefined}],27:[function(require,module,exports){
"use strict";
var LookConfigSlow = require("./LookConfigSlow");
var LookConfigDisengage = function (name, robotInfo) {
    LookConfigSlow.call(this, name, robotInfo, false);
};
...
},{"./LookConfigSlow":30}],28:[function(require,module,exports){
"use strict";
var LookConfig = require("./LookConfig");
var AnimationUtilities = require("animation-utilities");
var Bakery = AnimationUtilities.ui.Bakery;
var LookConfigEyeVision = function (name, robotInfo, modalityName, eyeOnly, torsoEnabled) {
    LookConfig.call(this, name, robotInfo, eyeOnly);
...
LookConfigEyeVision.prototype.configureBuilder = function (lookatBuilder) {
    ...
    var eyeConfig = lookatBuilder.getLookatNodeConfig("Eye");
    eyeConfig.acceleration = Bakery.getFloat("Eye accel: " + this.modalityName, 0, 5, 1, "ATMotion");
    eyeConfig.TPTDLimitInner = Bakery.getFloat("Eye dead zone: " + this.modalityName, 0, 0.1, 0.002, "ATMotion");
    ...
    if (!this.eyeOnly) {
        var baseConfig = lookatBuilder.getLookatNodeConfig("BaseLookatNode");
        baseConfig.TPTDLimitInner = Math.PI / 6;
        baseConfig.TPTDLimitOuter = Math.PI / 2;
        baseConfig.TPTDAccumInner = 0.2;
        baseConfig.TPTDAccumOuter = 0.5;
        baseConfig.TPTDMoveImmediatelyPastOuter = false;
        var torsoConfig = lookatBuilder.getLookatNodeConfig("TorsoLookatNode");
        torsoConfig.TPTDLimitInner = Math.PI / 18;
        torsoConfig.TPTDLimitOuter = Math.PI / 6;
        torsoConfig.TPTDAccumInner = 0;
        torsoConfig.TPTDAccumOuter = 0;
        torsoConfig.TPTDMoveImmediatelyPastOuter = true;
        torsoConfig.TPTPMoveIfParentMoves = true;
        var topConfig = lookatBuilder.getLookatNodeConfig("TopLookatNode");
        topConfig.TPTDLimitInner = Math.PI / 50;
        topConfig.TPTDLimitOuter = Math.PI / 6;
        topConfig.TPTDAccumInner = 0.15;
        topConfig.TPTDAccumOuter = 1;
        topConfig.TPTDMoveImmediatelyPastOuter = true;
        topConfig.TPTPMoveIfParentMoves = true;
    }
};
module.exports = LookConfigEyeVision;

},{"./LookConfig":26,"animation-utilities":undefined}],29:[function(require,module,exports){
"use strict";
var LookConfig = require("./LookConfig");
var LookConfigShort = function (name, robotInfo) {
    LookConfig.call(this, name, robotInfo, true);
...
},{"./LookConfig":26}],30:[function(require,module,exports){
"use strict";
var LookConfig = require("./LookConfig");
var LookConfigSlow = function (name, robotInfo, eyeOnly) {
    LookConfig.call(this, name, robotInfo, eyeOnly);
};
...
},{"./LookConfig":26}],31:[function(require,module,exports){
"use strict";
var LookConfigSlow = require("./LookConfigSlow");
var LookConfigUncommitted = function (name, robotInfo) {
    LookConfigSlow.call(this, name, robotInfo, false);
};
...
},{"./LookConfigSlow":30}],32:[function(require,module,exports){
"use strict";
var slog = require("animation-utilities").slog;
var channel = "ATTENTION";
...
},{"animation-utilities":undefined}],33:[function(require,module,exports){
"use strict";
...
},{"animation-utilities":undefined,"http":undefined,"websocket-without-native":undefined}],34:[function(require,module,exports){
"use strict";
...
},{"../AttentionDebugStateVisualizer":2}],37:[function(require,module,exports){
"use strict";
var AnimationUtilities = require("animation-utilities");
var Bakery = AnimationUtilities.ui.Bakery;
...
},{"animation-utilities":undefined}],38:[function(require,module,exports){
"use strict";
var SensoryRecord = require("../SensoryRecord");
...
},{"../SensoryRecord":11}],39:[function(require,module,exports){
"use strict";
...
},{"../AttentionManager":5,"animation-utilities":undefined}],40:[function(require,module,exports){
"use strict";
var AnimationUtilities = require("animation-utilities");
var Clock = AnimationUtilities.Clock;
...
},{"./AttentionModeHandler":32,"./AttentionServer":33,"./BodyStreamer":34,"./DoAnimHandler":35,"./DoColorHandler":36,"./DoLookHandler":37,"./ParsedSensoryStreamer":38,"./RemoteLogController":40}],42:[function(require,module,exports){
"use strict";
var AnimationUtilities = require("animation-utilities");
var Clock = AnimationUtilities.Clock;
var THREE = AnimationUtilities.THREE;
...
},{"../SensoryRecord":11,"animation-utilities":undefined}],43:[function(require,module,exports){
"use strict";
var slog = require("animation-utilities").slog;
var channel = "ATTENTION";
...
},{"./AttentionManager":5,"./DataConverter":7,"./SensoryRecord":11,"./remote/RemoteAttentionManager":39,"./remote/RemoteVisualizerConnection":41,"./remote/SensoryVisualizer":42,"./remote/SocketClient":43,"find-root":undefined}]},{},[44])(44)
});
