 ...
 * @param {jibo.loader.AssetManager} manager Instance of AssetManager.
 ...
 * @param {Boolean} [asset.remoteAll=false] `true` to force remote loading.
 ...
 */
declare class ListTask extends Task {
