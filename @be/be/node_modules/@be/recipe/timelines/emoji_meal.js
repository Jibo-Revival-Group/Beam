(function (PIXI, lib) {
    ...
    var Graphic1 = MovieClip.extend(function (mode) {
        ...
        var instance1 = new Sprite(fromFrame("meal-plate1"))
            .setTransform(-242.3, -242.35);
        this.addTimedChild(instance1);
    });

    var Graphic2 = MovieClip.extend(function (mode) {
        MovieClip.call(this, { mode: mode, duration: 44, loop: false });
        var instance1 = new Sprite(fromFrame("meal-fork1"))
            .setTransform(-38.75, -164.45);
        this.addTimedChild(instance1);
    });

    var Graphic3 = MovieClip.extend(function (mode) {
        MovieClip.call(this, { mode: mode, duration: 44, loop: false });
        var instance1 = new Sprite(fromFrame("meal-knife1"))
            .setTransform(-28, -167.2);
        this.addTimedChild(instance1);
    });
    ...
    var Graphic4 = MovieClip.extend(function (mode) {
        ...
        this.addTimedChild(instance3, 3, 44, {
                "3": {
                    x: 86.3,
                    y: -1.95,
                    sx: 1,
    ...
    lib.meal = MovieClip.extend(function () {
        MovieClip.call(this, {
            duration: 50,
            framerate: 30,
            loop: false,
    ...
    lib.meal.assets = {
        "meal_atlas_1": "images/meal_atlas_1.json"
    };
})(PIXI, lib = lib || {});
var lib;
