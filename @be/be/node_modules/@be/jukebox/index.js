...
class JukeboxSkill extends be_framework_1.BeSkill {
    ...
    finishOpen() {
        try {
            ...
            try {
                this.musicView = new MusicView_1.default(scan.albums);
            }
            catch (err) {
                console.error('[jukebox] MusicView failed:', err);
                if (this.status) {
                    this.status.showError('Player UI failed to start.', (scan.detail ? scan.detail + '\n\n' : '') +
...
class MusicLibrary {
    static scan(assetPack) {
        const empty = { albums: [], dir: null, error: null, detail: '' };
        try {
            let fs;
            let path;
            try {
    ...
    static scanAlbum(folderName, albumPath, assetPack, fs, path) {
    ...
    static resolveAssetUrl(relPath, assetPack) {
        try {
            const PathUtils = jibo.utils && jibo.utils.PathUtils;
            if (PathUtils && typeof PathUtils.getAssetUri === 'function') {
...
},{"fs":undefined,"jibo":undefined,"path":undefined}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
    ...
    buildAlbumsScreen() {
        ...
        if (this.albums.length === 0) {
            ...
            this.applyStyle(empty, {
                ...
                fontSize: '28px', lineHeight: '1.55', color: 'rgba(242,244,247,0.72)'
            });
            empty.textContent = 'No albums found. Add a folder under music/ with a cover.png and your audio files, then reopen Jukebox.';
