...
export declare const PartOfDay: {
    MORNING: string;
    AFTERNOON: string;
    EVENING: string;
    NIGHT: string;
...
export declare class TimeUtils {
     ...
     * @private
     */
    static _dateProvider: DateProvider;
    /**
    ...
    static _dispatchTimeline(el: TimelineElement, startTime: number[]): Promise<any>;
    /**
     ...
     * @returns {PartOfDay}
     */
    static getPartOfDay(date?: Date): string;
    /**
