...
/**
 * Set the mode governing the attention system's behavior.
 * @method jibo.attention#setMode
 * @param {jibo.attention.Mode} mode - The new attention system mode: IDLE, ENGAGED, OFF, etc.
 */
