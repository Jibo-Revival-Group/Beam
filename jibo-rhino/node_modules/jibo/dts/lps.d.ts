...
declare type Callback = (err?: string|Error, data?:any) => void;
export default class LPSService {
    ...
    getFaces(cameraId:number, cb:Callback, kind:string, initTracks:boolean):void;
    demandDetect(cameraId:number, redetect:boolean, cb:Callback):void;
    setPreview(data:PreviewData, callback:Callback):void;
